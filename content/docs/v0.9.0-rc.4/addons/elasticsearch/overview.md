...
<figure align="center">
 <img alt="Elasticsearch Backup Overview" src="/docs/v0.9.0-rc.4/images/addons/elasticsearch/backup_overview.svg">
...
<figure align="center">
 <img alt="Database Restore Overview" src="/docs/v0.9.0-rc.4/images/addons/elasticsearch/restore_overview.svg">
...
- Install Elasticsearch addon for Stash following the guide from [here](/docs/v0.9.0-rc.4/addons/elasticsearch/setup/install).
