...
menu:
  docs_v2021.03.08:
    identifier: mariadb-guides-10.5.8-v1-auto-backup
    name: Auto-Backup
    parent: stash-mariadb-guides-10.5.8-v1
    weight: 30
product_name: stash
...
- If you are not familiar with how Stash backup and restore MariaDB databases, please check the following guide [here](/docs/v2021.03.08/addons/mariadb/overview).
...
Make sure you have installed the MariaDB addon for Stash. If you haven't installed it already, please install the addon following the steps [here](/docs/v2021.03.08/addons/mariadb/setup/install).
...
Now, we are ready to backup our MariaDB databases using few annotations. You can check available auto-backup annotations for a databases from [here](/docs/v2021.03.08/guides/latest/auto-backup/database/#available-auto-backup-annotations-for-database).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.08/addons/mariadb/guides/{{< param "info.subproject_version" >}}/auto-backup/images/sample-mariadb.png">
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.08/addons/mariadb/guides/{{< param "info.subproject_version" >}}/auto-backup/images/sample-mariadb-2.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.08/addons/mariadb/guides/{{< param "info.subproject_version" >}}/auto-backup/images/sample-mariadb-3.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
