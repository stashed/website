...
We are going to use [GCS Backend](/docs/v2022.02.22/guides/backends/gcs) to store the backed up data. You can use any supported backend you prefer. You just have to configure Storage Secret and `spec.backend` section of `BackupBlueprint` to match your backend. To learn which backends are supported by Stash and how to configure them, please visit [here](/docs/v2022.02.22/guides/backends/overview).
...
<figure align="center">
  <img alt="Backup data in GCS backend" src="/docs/v2022.02.22/images/guides/auto-backup/workload/deployment_repo.png">
...
<figure align="center">
  <img alt="Backup data of `sts-demo` StatefulSet in GCS backend" src="/docs/v2022.02.22/images/guides/auto-backup/workload/statefulset_repo.png">
...
<figure align="center">
  <img alt="Backup data of `dmn-demo` DaemonSet in GCS backend" src="/docs/v2022.02.22/images/guides/auto-backup/workload/daemon_repo.png">
...
If you would like to uninstall Stash operator, please follow the steps [here](/docs/v2022.02.22/setup/README).
