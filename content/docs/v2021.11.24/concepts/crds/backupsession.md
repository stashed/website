...
- Learn how backup of workloads data works from [here](/docs/v2021.11.24/guides/latest/workloads/overview).
- Learn how backup of databases works from [here](/docs/v2021.11.24/guides/latest/addons/overview).
- Learn how backup stand alone PVC works from [here](/docs/v2021.11.24/guides/latest/volumes/overview).
