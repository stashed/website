...
If you want to use a different backend, please read the doc [here](/docs/v2022.03.29/guides/backends/overview).
...
Notice the `spec.usagePolicy` section. Here, we are allowing all namespaces to refer to this repository. You can restrict this capability to a particular namespace or to a group of namespaces. Please, check the following guide from [here](/docs/v2022.03.29/concepts/crds/repository) for more details.
...
At first, let's stop taking any further backup of the old StatefulSet. We are going to pause the `BackupConfiguration` that we created earlier. You can learn more how to pause a scheduled backup [here](/docs/v2022.03.29/guides/use-cases/pause-backup)
