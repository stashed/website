...
- Learn how to use Stash in Azure Kubernetes Service (AKS) from [here](/docs/v0.9.0-rc.0/guides/v1alpha1/platforms/aks).
- Learn how to use Stash to backup a Kubernetes deployment from [here](/docs/v0.9.0-rc.0/guides/v1alpha1/backup).
- Learn how to recover from backed up snapshot from [here](/docs/v0.9.0-rc.0/guides/v1alpha1/restore).
