...
menu:
  docs_v2020.08.26-rc.1:
    identifier: standalone-elasticsearch-6.3.0-rc.20200826
    name: Backup & Restore Elasticsearch
    parent: stash-elasticsearch-guides-6.3.0-rc.20200826
    weight: 10
product_name: stash
...
- Install Elasticsearch addon for Stash following the steps [here](/docs/v2020.08.26-rc.1/addons/elasticsearch/setup/install).
...
- If you are not familiar with how Stash backup and restore Elasticsearch databases, please check the following guide [here](/docs/v2020.08.26-rc.1/addons/elasticsearch/overview).
...
Here, we have to use service `sample-elasticsearch` and secret `sample-elasticsearch-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2020.08.26-rc.1/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
