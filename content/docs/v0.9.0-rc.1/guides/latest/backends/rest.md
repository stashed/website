...
- Learn how to use Stash to backup workloads data from [here](/docs/v0.9.0-rc.1/guides/latest/workloads/overview).
- Learn how to use Stash to backup databases from [here](/docs/v0.9.0-rc.1/guides/latest/databases/overview).
- Learn how to use Stash to backup stand-alone PVC from [here](/docs/v0.9.0-rc.1/guides/latest/volumes/overview).
