...
`spec.task` specifies the name and parameters of the [Task](/docs/v2020.07.09-beta.0/concepts/crds/task) crd to use to backup the target.
...
- Learn how to configure `BackupConfiguration` to backup workloads data from [here](/docs/v2020.07.09-beta.0/guides/latest/workloads/overview).
- Learn how to configure `BackupConfiguration` to backup databases from [here](/docs/v2020.07.09-beta.0/guides/latest/addons/overview).
- Learn how to configure `BackupConfiguration` to backup stand-alone PVC from [here](/docs/v2020.07.09-beta.0/guides/latest/volumes/overview).
