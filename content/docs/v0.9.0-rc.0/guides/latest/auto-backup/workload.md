...
We are going to use [GCS Backend](/docs/v0.9.0-rc.0/guides/latest/backends/gcs) to store the backed up data. You can use any supported backend you prefer. You just have to configure Storage Secret and `spec.backend` section of `BackupBlueprint` to match your backend. To learn which backends are supported by Stash and how to configure them, please visit [here](/docs/v0.9.0-rc.0/guides/latest/backends/overview).
...
<figure align="center">
  <img alt="Backup data in GCS backend" src="/docs/v0.9.0-rc.0/images/guides/latest/auto-backup/workload/deployment_repo.png">
...
<figure align="center">
  <img alt="Backup data of `sts-demo` StatefulSet in GCS backend" src="/docs/v0.9.0-rc.0/images/guides/latest/auto-backup/workload/statefulset_repo.png">
...
<figure align="center">
  <img alt="Backup data of `dmn-demo` DaemonSet in GCS backend" src="/docs/v0.9.0-rc.0/images/guides/latest/auto-backup/workload/daemon_repo.png">
