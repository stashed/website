...
url: /docs/v2024.2.9-rc.0/addons/etcd/
aliases:
- /docs/v2024.2.9-rc.0/addons/etcd/README/
info:
  cli: v0.33.0-rc.0
...
- [How does it work?](/docs/v2024.2.9-rc.0/addons/etcd/overview/) gives an overview of how backup and restore process for Etcd database works in Stash.
- [Etcd Cluster with Basic Auth](/docs/v2024.2.9-rc.0/addons/etcd/basic-auth/) shows how to backup and restore an Etcd cluster with basic authentication enabled.
- [Etcd Cluster with TLS](/docs/v2024.2.9-rc.0/addons/etcd/tls/) shows how to configure backup and restore process for TLS secured Etcd cluster.
- [Customizing Backup & Restore Process](/docs/v2024.2.9-rc.0/addons/etcd/customization/) shows how to customize the backup & restore process.
