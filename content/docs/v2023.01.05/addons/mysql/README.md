...
url: /docs/v2023.01.05/addons/mysql/
aliases:
- /docs/v2023.01.05/addons/mysql/README/
info:
  cli: v0.25.0
  community: v0.25.0
  elasticsearch:
...
- [How does it work?](/docs/v2023.01.05/addons/mysql/overview/) gives an overview of how backup and restore process for MySQL database works in Stash.
- [Standalone MySQL Database](/docs/v2023.01.05/addons/mysql/standalone/) shows how to backup and restore a standalone MySQL database.
