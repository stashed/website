...
You have to create a [Repository](/docs/v2022.12.11/concepts/crds/repository/) object which contains backend information and a `Secret` which contains necessary credentials to access the backend.
...
- Learn how to configure `Kubernetes Volume` as backend from [here](/docs/v2022.12.11/guides/backends/local/).
- Learn how to configure `AWS S3/Minio/Rook` backend from [here](/docs/v2022.12.11/guides/backends/s3/).
- Learn how to configure `Google Cloud Storage (GCS)` backend from [here](/docs/v2022.12.11/guides/backends/gcs/).
- Learn how to configure `Microsoft Azure Storage` backend from [here](/docs/v2022.12.11/guides/backends/azure/).
- Learn how to configure `OpenStack Swift` backend from [here](/docs/v2022.12.11/guides/backends/swift/).
- Learn how to configure `Backblaze B2` backend from [here](/docs/v2022.12.11/guides/backends/b2/).
- Learn how to configure `REST` backend from [here](/docs/v2022.12.11/guides/backends/rest/).
