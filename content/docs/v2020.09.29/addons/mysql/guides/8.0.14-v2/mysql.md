...
menu:
  docs_v2020.09.29:
    identifier: mysql-guide-8.0.14-v2
    name: Backup & Restore MySQL
    parent: stash-mysql-guides-8.0.14-v2
    weight: 10
product_name: stash
...
Here, we have to use service `sample-mysql` and secret `sample-mysql-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2020.09.29/concepts/crds/appbinding) CRD that holds the necessary information to connect with the database.
