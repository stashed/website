...
> **Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/latest/platforms/minio](/docs/v2020.11.17/examples/guides/latest/platforms/minio) directory of [stashed/doc](https://github.com/stashed/doc) repository.
...
<figure align="center">
  <img alt="Backup data in Minio Bucket" src="/docs/v2020.11.17/images/guides/latest/platforms/minio.png">
