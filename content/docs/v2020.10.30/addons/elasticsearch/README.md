...
url: /docs/v2020.10.30/addons/elasticsearch/
aliases:
- /docs/v2020.10.30/addons/elasticsearch/README/
info:
  catalog: v2020.10.30
  cli: v0.11.5
  community: v0.11.5
...
{{< versionlist "elasticsearch" "/docs/v2020.10.30/addons/elasticsearch/guides/%s/elasticsearch" >}}
...
- [How does it works?](/docs/v2020.10.30/addons/elasticsearch/overview) gives an overview of how backup and restore process for Elasticsearch database works in Stash.
- [Setup](/docs/v2020.10.30/addons/elasticsearch/setup/install) shows how to install and uninstall Elasticsearch addon for Stash.
- [Guides](/docs/v2020.10.30/addons/elasticsearch/guides/6.5/elasticsearch) contains step by step guides to backup and restore different versions of Elasticsearch databases.
