...
- If you are not familiar with how Stash backup and restore Etcd databases, please check the following guide [here](/docs/v2023.08.18/addons/etcd/overview/).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2023.08.18/addons/etcd/tls/images/etcd-tls-backup.jpg">
