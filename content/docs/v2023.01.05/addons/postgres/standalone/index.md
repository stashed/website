...
Here, we have to use the service `sample-postgres` and secret `sample-postgres-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2023.01.05/concepts/crds/appbinding/) crd that holds the necessary information to connect with the database.
...
<figure align="center">
 <img alt="Backup data in GCS Bucket" src="/docs/v2023.01.05/addons/postgres/standalone/images/sample-postgres-backup.png">
