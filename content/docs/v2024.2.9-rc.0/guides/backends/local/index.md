...
>For NFS backend, Stash may have to run the network volume accessor deployments in privileged mode to provide Snapshot listing facility. In this case, please configure network volume accessors by following the instruction [here](/docs/v2024.2.9-rc.0/setup/install/troubleshooting/#configuring-network-volume-accessor).
