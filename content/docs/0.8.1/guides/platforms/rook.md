...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/rook](/docs/0.8.1/examples/platforms/rook) directory of [appscode/stash](https://github.com/appscode/stash) repository.
