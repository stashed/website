...
- At first, you need to have some backup taken by Stash. If you already don't have any backup repository, create one by following this [backup tutorial](/docs/v2020.11.17/guides/v1alpha1/backup).
...
- You need to have `Repository` crd that was created for the respective backup. If you have lost the `Repository` crd, you have to create it manually with respective backend information. Follow, [this guide](/docs/v2020.11.17/concepts/crds/repository) to understand structure of `Repository` crd.
...
>Note: YAML files used in this tutorial are stored in [/docs/examples/recovery](/docs/v2020.11.17/examples/recovery) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<p align="center">
  <img alt="Stash Backup Flow" src="/docs/v2020.11.17/images/v1alpha1/stash-recovery.svg">
</p>
...
With the help of [Snapshot](/docs/v2020.11.17/concepts/crds/snapshot) object, Stash allows users to recover from a particular snapshot. Here is an example of how to recover from a specific snapshot.
...
>Note: If you are using [Local](/docs/v2020.11.17/guides/v1alpha1/backends/local) backend for storing backup snapshots, your workload must be running to be able to list snapshots.
