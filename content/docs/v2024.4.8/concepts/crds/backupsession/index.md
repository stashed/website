...
- Learn how backup of workloads data works from [here](/docs/v2024.4.8/guides/workloads/overview/).
- Learn how backup of databases works from [here](/docs/v2024.4.8/guides/addons/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2024.4.8/guides/volumes/overview/).
