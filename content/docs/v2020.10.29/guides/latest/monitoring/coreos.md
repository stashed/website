...
Enable Prometheus monitoring using `prometheus.io/operator` agent while installing Stash. To know details about how to enable monitoring see [here](/docs/v2020.10.29/guides/latest/monitoring/overview#how-to-enable-monitoring).
...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v2020.10.29/images/guides/latest/monitoring/prom-coreos-target.png">
...
- Learn how to monitor Stash using builtin Prometheus from [here](/docs/v2020.10.29/guides/latest/monitoring/builtin).
