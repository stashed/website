...
url: /docs/v2021.01.21/addons/mariadb/
aliases:
- /docs/v2021.01.21/addons/mariadb/README/
info:
  catalog: v2021.01.21
  cli: v0.11.9
  community: v0.11.9
...
{{< versionlist "mariadb" "/docs/v2021.01.21/addons/mariadb/guides/%s/helm/logical" >}}
...
- [How does it works?](/docs/v2021.01.21/addons/mariadb/overview) gives an overview of how backup and restore process for MariaDB database works in Stash.
- [Setup](/docs/v2021.01.21/addons/mariadb/setup/install) shows how to install and uninstall MariaDB addon for Stash.
