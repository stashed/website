...
Install `Stash` in your `prod` cluster following the steps [here](/docs/v2022.09.29/setup/README).
...
If you want to use a different backend, please read the respective backend configuration doc [here](/docs/v2022.09.29/guides/backends/overview/).
...
Install `Stash` in your `staging` cluster following the steps [here](/docs/v2022.09.29/setup/README).
