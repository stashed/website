...
url: /docs/v2020.12.17/addons/elasticsearch/
aliases:
- /docs/v2020.12.17/addons/elasticsearch/README/
info:
  catalog: v2020.12.17
  cli: v0.11.8
  community: v0.11.8
...
{{< versionlist "elasticsearch" "/docs/v2020.12.17/addons/elasticsearch/guides/%s/elasticsearch" >}}
...
- [How does it works?](/docs/v2020.12.17/addons/elasticsearch/overview) gives an overview of how backup and restore process for Elasticsearch database works in Stash.
- [Setup](/docs/v2020.12.17/addons/elasticsearch/setup/install) shows how to install and uninstall Elasticsearch addon for Stash.
