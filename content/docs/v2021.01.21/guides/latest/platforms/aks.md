...
> **Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/latest/platforms/aks](/docs/v2021.01.21/examples/guides/latest/platforms/aks) directory of [stashed/doc](https://github.com/stashed/doc) repository.
...
<figure align="center">
  <img alt="Backup data in Azure Blob Storage Container" src="/docs/v2021.01.21/images/guides/latest/platforms/aks.png">
