...
To know more about the available options for retention policies, please visit [here](/docs/v2023.10.9/concepts/crds/backupconfiguration/#specretentionpolicy).
