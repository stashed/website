...
`spec.task` specifies the name and parameters of the [Task](/docs/v2021.04.12/concepts/crds/task) crd to use to restore the target data.
...
- Learn how restore of workloads data works from [here](/docs/v2021.04.12/guides/latest/workloads/overview).
- Learn how restore of databases works from [here](/docs/v2021.04.12/guides/latest/addons/overview).
- Learn how restore stand-alone PVC works from [here](/docs/v2021.04.12/guides/latest/volumes/overview).
