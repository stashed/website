...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2021.04.09/images/guides/latest/volumesnapshot/volumesnapshot-overview.svg">
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2021.04.09/images/guides/latest/volumesnapshot/restore-overview.svg">
...
1. See a step by step guide to snapshot the volumes of a Deployment [here](/docs/v2021.04.09/guides/latest/volumesnapshot/deployment).
2. See a step by step guide to snapshot the volumes of a StatefulSet [here](/docs/v2021.04.09/guides/latest/volumesnapshot/statefulset).
3. See a step by step guide to snapshot a stand-alone PVC [here](/docs/v2021.04.09/guides/latest/volumesnapshot/pvc).
