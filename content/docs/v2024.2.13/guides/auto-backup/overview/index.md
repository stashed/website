...
7. Finally, Stash starts rest of the standard backup process as discussed in [here](/docs/v2024.2.13/guides/workloads/overview/).
...
- Learn how to configure automatic backup for workloads from [here](/docs/v2024.2.13/guides/auto-backup/workload/).
- Learn how to configure automatic backup for PVCs from [here](/docs/v2024.2.13/guides/auto-backup/pvc/).
- Learn how to configure automatic backup for databases from [here](/docs/v2024.2.13/guides/auto-backup/database/).
