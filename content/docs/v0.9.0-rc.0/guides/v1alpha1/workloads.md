...
You can find the full working demo in [examples folder](/docs/v0.9.0-rc.0/examples/workloads/statefulset.yaml). The section you should change for your own StatefulSet are:
...
To learn about the meaning of various flags, please visit [here](/docs/v0.9.0-rc.0/reference/stash_backup).
...
- Wondering what features are coming next? Please visit [here](/docs/v0.9.0-rc.0/roadmap).
