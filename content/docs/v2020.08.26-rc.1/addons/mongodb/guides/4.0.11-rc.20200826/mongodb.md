...
menu:
  docs_v2020.08.26-rc.1:
    identifier: standalone-mongodb-4.0.11-rc.20200826
    name: Standalone MongoDB
    parent: stash-mongodb-guides-4.0.11-rc.20200826
    weight: 10
product_name: stash
...
- Install MongoDB addon for Stash following the steps [here](/docs/v2020.08.26-rc.1/addons/mongodb/setup/install).
...
- If you are not familiar with how Stash backup and restore MongoDB databases, please check the following guide [here](/docs/v2020.08.26-rc.1/addons/mongodb/overview).
...
Here, we have to use service `sample-mongodb` and secret `sample-mongodb-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2020.08.26-rc.1/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
