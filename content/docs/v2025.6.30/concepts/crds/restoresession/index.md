...
`spec.task` specifies the name and parameters of the [Task](/docs/v2025.6.30/concepts/crds/task/) crd to use to restore the target data.
...
- Learn how restore of databases works from [here](/docs/v2025.6.30/guides/addons/overview/).
