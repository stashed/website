...
- Learn how to use Stash in Amazon Elastic Container Service for Kubernetes (EKS) from [here](/docs/v0.9.0-rc.0/guides/v1alpha1/platforms/eks).
- Learn how to use Stash with S3 compatible Mino Storage Server from [here](/docs/v0.9.0-rc.0/guides/v1alpha1/platforms/minio).
- Learn how to use Stash with S3 comptatibe Rook Storage Service from [here](/docs/v0.9.0-rc.0/guides/v1alpha1/platforms/rook).
