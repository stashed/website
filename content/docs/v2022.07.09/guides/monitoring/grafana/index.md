...
- At first, you need to setup a Prometheus monitoring stack in your cluster. Please, follow the [Prometheus Operator](/docs/v2022.07.09/guides/monitoring/prom-operator/) guide to setup your monitoring stack if you haven't done already.
- Then, install Stash Enterprise edition with monitoring enabled. Please, follow [this guide](/docs/v2022.07.09/guides/monitoring/prom-operator/#enable-monitoring-in-stash) if you haven't done already.
...
<figure align="center">
  <img alt="Import Stash Grafana Dashboard: Step 2" src="/docs/v2022.07.09/guides/monitoring/grafana/images/import_dashboard_2.png">
...
<figure align="center">
  <img alt="Import Stash Grafana Dashboard: Step 3" src="/docs/v2022.07.09/guides/monitoring/grafana/images/import_dashboard_3.png">
...
<figure align="center">
  <img alt="Stash Grafana Dashboard" src="/docs/v2022.07.09/guides/monitoring/grafana/images/stash_grafana_dashboard.png">
