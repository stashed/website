...
url: /docs/v2021.01.21/guides/v1alpha1/
aliases:
- /docs/v2021.01.21/guides/v1alpha1/README/
info:
  catalog: v2021.01.21
  cli: v0.11.9
  community: v0.11.9
...
- Learn to use Stash in Google Kubernetes Engine [here](/docs/v2021.01.21/guides/v1alpha1/platforms/gke)
- Learn to use Stash with self-hosted TLS secured Minio Server [here](/docs/v2021.01.21/guides/v1alpha1/platforms/minio).
- Learn to use Stash in Rook Storage System [here](/docs/v2021.01.21/guides/v1alpha1/platforms/rook)
