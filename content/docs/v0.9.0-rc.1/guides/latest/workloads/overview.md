...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v0.9.0-rc.1/images/guides/latest/workloads/backup_overview.svg">
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v0.9.0-rc.1/images/guides/latest/workloads/restore_overview.svg">
...
1. See a step by step guide to backup/restore volumes of a Deployment [here](/docs/v0.9.0-rc.1/guides/latest/workloads/deployment).
2. See a step by step guide to backup/restore volumes of a StatefulSet [here](/docs/v0.9.0-rc.1/guides/latest/workloads/statefulset).
3. See a step by step guide to backup/restore a Daemonset's volumes [here](/docs/v0.9.0-rc.1/guides/latest/workloads/daemonset).
