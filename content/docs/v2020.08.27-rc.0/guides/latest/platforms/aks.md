...
> **Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/latest/platforms/aks](/docs/v2020.08.27-rc.0/examples/guides/latest/platforms/aks) directory of [stashed/doc](https://github.com/stashed/doc) repository.
...
<figure align="center">
  <img alt="Backup data in Azure Blob Storage Container" src="/docs/v2020.08.27-rc.0/images/guides/latest/platforms/aks.png">
