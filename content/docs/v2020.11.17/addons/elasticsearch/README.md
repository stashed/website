...
url: /docs/v2020.11.17/addons/elasticsearch/
aliases:
- /docs/v2020.11.17/addons/elasticsearch/README/
info:
  catalog: v2020.11.17
  cli: v0.11.7
  community: v0.11.7
...
{{< versionlist "elasticsearch" "/docs/v2020.11.17/addons/elasticsearch/guides/%s/elasticsearch" >}}
...
- [How does it works?](/docs/v2020.11.17/addons/elasticsearch/overview) gives an overview of how backup and restore process for Elasticsearch database works in Stash.
- [Setup](/docs/v2020.11.17/addons/elasticsearch/setup/install) shows how to install and uninstall Elasticsearch addon for Stash.
- [Guides](/docs/v2020.11.17/addons/elasticsearch/guides/6.5/elasticsearch) contains step by step guides to backup and restore different versions of Elasticsearch databases.
