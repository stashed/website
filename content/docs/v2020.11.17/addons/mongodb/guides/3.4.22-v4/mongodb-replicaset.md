...
menu:
  docs_v2020.11.17:
    identifier: mongodb-replicaset-3.4.22-v4
...
KubeDB creates an [AppBinding](/docs/v2020.11.17/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
