...
- Learn how backup of workloads data works from [here](/docs/v2024.8.27/guides/workloads/overview/).
- Learn how backup of databases works from [here](/docs/v2024.8.27/guides/addons/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2024.8.27/guides/volumes/overview/).
