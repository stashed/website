...
- Install `Stash` in your cluster following the steps [here](/docs/v2025.7.31/setup/README).
...
<figure align="center">
  <img alt="Create IAM policy" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/create-bucket-policy-1.png">
  <figcaption align="center">Fig: Create IAM policy</figcaption>
</figure>

<figure align="center">
  <img alt="Review IAM policy" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/create-bucket-policy-2.png">
...
<figure align="center">
  <img alt="Create IAM role (Step: 1)" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/create-role-1.png">
  <figcaption align="center">Fig: Create IAM Role (Step: 1)</figcaption>
</figure>

<figure align="center">
  <img alt="Create IAM role (Step: 2)" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/create-role-2.png">
  <figcaption align="center">Fig: Create IAM Role (Step: 2)</figcaption>
</figure>

<figure align="center">
  <img alt="Create IAM role (Step: 3)" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/create-role-3.png">
...
<figure align="center">
  <img alt="Create IAM policy (Step: 1)" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/create-assume-policy-1.png">
  <figcaption align="center">Fig: Create IAM policy (Step: 1)</figcaption>
</figure>

<figure align="center">
  <img alt="Create IAM policy(Step: 2) " src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/create-assume-policy-2.png">
...
<figure align="center">
  <img alt="Attach IAM policy(Step: 1" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/attach-policy-1.png">
  <figcaption align="center">Fig: Attach Policy (Step: 1)</figcaption>
</figure>

<figure align="center">
  <img alt="Attach IAM policy(Step: 2" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/attach-policy-2.png">
...
<figure align="center">
  <img alt="Update Trust policy(Step: 1" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/trust-policy-1.png">
  <figcaption align="center">Fig: Update Trust Policy (Step: 1)</figcaption>
</figure>

<figure align="center">
  <img alt="Update Trust policy(Step: 2" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/trust-policy-2.png">
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2025.7.31/guides/platforms/eks-kube2iam/images/gcs.png">
