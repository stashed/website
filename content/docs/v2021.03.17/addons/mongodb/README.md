...
url: /docs/v2021.03.17/addons/mongodb/
aliases:
- /docs/v2021.03.17/addons/mongodb/README/
info:
  cli: v0.12.0
  community: v0.12.0
  elasticsearch:
...
- [How does it works?](/docs/v2021.03.17/addons/mongodb/overview/) gives an overview of how backup and restore process for MongoDB database works in Stash.
- [Standalone MongoDB](/docs/v2021.03.17/addons/mongodb/standalone/) shows how to backup and restore a standalone MongoDB database.
- [MongoDB ReplicaSet](/docs/v2021.03.17/addons/mongodb/replicaset/) shows how to backup & restore  a MongoDB ReplicaSet.
- [Sharded MongoDB Cluster](/docs/v2021.03.17/addons/mongodb/sharding/) shows how to backup & restore a sharded MongoDB cluster.
