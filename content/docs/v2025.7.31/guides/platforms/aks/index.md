...
> **Note:** YAML files used in this tutorial are stored in  [docs/guides/platforms/aks/examples](/docs/v2025.7.31/guides/platforms/aks/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Backup data in Azure Blob Storage Container" src="/docs/v2025.7.31/guides/platforms/aks/images/aks.png">
