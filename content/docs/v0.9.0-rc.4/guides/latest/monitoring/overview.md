...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v0.9.0-rc.4/images/guides/latest/monitoring/stash-monitoring-structure.svg">
...
- Learn how to monitor Stash using built-in Prometheus from [here](/docs/v0.9.0-rc.4/guides/latest/monitoring/builtin).
