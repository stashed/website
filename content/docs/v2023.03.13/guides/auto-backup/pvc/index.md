...
>**Note:** YAML files used in this tutorial are stored in  [docs/guides/auto-backup/pvc/examples](/docs/v2023.03.13/guides/auto-backup/pvc/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
If you would like to uninstall Stash operator, please follow the steps [here](/docs/v2023.03.13/setup/README).
