...
url: /docs/v2023.04.30/addons/kubedump/
aliases:
- /docs/v2023.04.30/addons/kubedump/README/
info:
  cli: v0.29.0
  community: v0.29.0
  elasticsearch:
...
- [How does it work?](/docs/v2023.04.30/addons/kubedump/overview/) gives an overview of how manifest backup works in Stash.
- [Cluster Backup](/docs/v2023.04.30/addons/kubedump/cluster/) shows how to backup all the cluster manifests.
- [Namespace Backup](/docs/v2023.04.30/addons/kubedump/namespace/) shows how to backup the manifests only for a particular namespace.
- [Application Backup](/docs/v2023.04.30/addons/kubedump/application/) shows how to manifests of a particular application.
- [Customizing Backup](/docs/v2023.04.30/addons/kubedump/customization/) shows how to customize the backup process.
