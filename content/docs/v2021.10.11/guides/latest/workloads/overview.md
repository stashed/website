...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2021.10.11/images/guides/latest/workloads/backup_overview.svg">
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2021.10.11/images/guides/latest/workloads/restore_overview.svg">
...
1. See a step by step guide to backup/restore volumes of a Deployment [here](/docs/v2021.10.11/guides/latest/workloads/deployment).
2. See a step by step guide to backup/restore volumes of a StatefulSet [here](/docs/v2021.10.11/guides/latest/workloads/statefulset).
3. See a step by step guide to backup/restore a Daemonset's volumes [here](/docs/v2021.10.11/guides/latest/workloads/daemonset).
