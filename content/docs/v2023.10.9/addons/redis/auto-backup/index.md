...
Now, we are ready to backup our Redis databases using few annotations. You can check available auto-backup annotations for a databases from [here](/docs/v2023.10.9/guides/auto-backup/database/#available-auto-backup-annotations-for-database).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2023.10.9/addons/redis/auto-backup/images/sample-redis-1.png">
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2023.10.9/addons/redis/auto-backup/images/sample-redis-2.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2023.10.9/addons/redis/auto-backup/images/sample-redis-3.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
