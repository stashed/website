...
To use Stash in a RBAC enabled cluster, [install Stash](/docs/v2021.6.18/setup/README) with RBAC options. This creates a ClusterRole named `stash-sidecar`.
...
You can find full working examples [here](/docs/v2021.6.18/guides/v1alpha1/workloads).
