...
Now, let’s backup the directory into a [AWS S3](/docs/0.7.0-rc.5/guides/backends#aws-s3) compatible Rook Object Storage.
...
Uninstall Stash following the instructions [here](/docs/0.7.0-rc.5/setup/uninstall).