...
> Note: YAML files used in this tutorial are stored in [/docs/guides/volumesnapshot/pvc/examples](/docs/v2023.03.13/guides/volumesnapshot/pvc/examples/) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2023.03.13/guides/volumesnapshot/pvc/images/gcp.png">
