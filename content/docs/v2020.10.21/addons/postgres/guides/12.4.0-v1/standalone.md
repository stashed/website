...
menu:
  docs_v2020.10.21:
    identifier: standalone-postgres-12.4.0-v1
    name: Standalone PostgreSQL
    parent: stash-postgres-guides-12.4.0-v1
    weight: 10
product_name: stash
...
sample-postgres   12.4      Running   3m11s
```
...
NAME                VERSION   STATUS         AGE
restored-postgres   12.4      Initializing   3m21s
```
...
$ kubectl get pg -n demo restored-postgres
NAME                VERSION   STATUS    AGE
restored-postgres   12.4      Running   2m16s
```
