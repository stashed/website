...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v2020.08.26-rc.1/images/guides/latest/monitoring/stash-monitoring-structure.svg">
...
- Learn how to monitor Stash using built-in Prometheus from [here](/docs/v2020.08.26-rc.1/guides/latest/monitoring/builtin).
