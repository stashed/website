...
- If you are not familiar with how Stash backup and restore MongoDB databases, please check the following guide [here](/docs/v2022.06.21/addons/mongodb/overview/).
...
KubeDB creates an [AppBinding](/docs/v2022.06.21/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
