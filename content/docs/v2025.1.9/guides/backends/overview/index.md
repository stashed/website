...
You have to create a [Repository](/docs/v2025.1.9/concepts/crds/repository/) object which contains backend information and a `Secret` which contains necessary credentials to access the backend.
...
- Learn how to configure `OpenStack Swift` backend from [here](/docs/v2025.1.9/guides/backends/swift/).
- Learn how to configure `Backblaze B2` backend from [here](/docs/v2025.1.9/guides/backends/b2/).
- Learn how to configure `REST` backend from [here](/docs/v2025.1.9/guides/backends/rest/).
