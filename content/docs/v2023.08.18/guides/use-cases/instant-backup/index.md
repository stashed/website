...
>**Note:** YAML files used in this tutorial are stored in  [docs/guides/use-cases/instant-backup/examples](/docs/v2023.08.18/guides/use-cases/instant-backup/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
