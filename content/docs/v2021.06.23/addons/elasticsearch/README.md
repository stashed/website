...
url: /docs/v2021.06.23/addons/elasticsearch/
aliases:
- /docs/v2021.06.23/addons/elasticsearch/README/
info:
  cli: v0.14.1
  community: v0.14.1
  elasticsearch:
...
- [How does it works?](/docs/v2021.06.23/addons/elasticsearch/overview/) gives an overview of how backup and restore process for Elasticsearch database works in Stash.
- [KubeDB managed Elasticsearch](/docs/v2021.06.23/addons/elasticsearch/kubedb/) shows how to backup and restore a KubeDB managed Elasticsearch database.
- [Auto-Backup](/docs/v2021.06.23/addons/elasticsearch/auto-backup/) shows how to configure a generic backup template for all the Elasticsearch databases of a cluster.
- [Customizing Backup & Restore Process](/docs/v2021.06.23/addons/elasticsearch/customization/) shows how to customize the backup & restore process.
