...
- Install Stash `kubectl` plugin in your local machine following the steps [here](/docs/v2022.06.27/setup/install/kubectl_plugin).
- If you are not familiar with how Stash backup the resource YAMLs, please check the following guide [here](/docs/v2022.06.27/addons/kubedump/overview/).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2022.06.27/addons/kubedump/application/images/application_manifest_backup.png">
