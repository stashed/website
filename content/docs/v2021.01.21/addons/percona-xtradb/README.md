...
url: /docs/v2021.01.21/addons/percona-xtradb/
aliases:
- /docs/v2021.01.21/addons/percona-xtradb/README/
info:
  catalog: v2021.01.21
  cli: v0.11.9
  community: v0.11.9
...
{{< versionlist "percona-xtradb" "/docs/v2021.01.21/addons/percona-xtradb/guides/%s/clustered" >}}
...
- [How does it works?](/docs/v2021.01.21/addons/percona-xtradb/overview) gives an overview of how backup and restore process for Percona XtraDB database works in Stash.
- [Setup](/docs/v2021.01.21/addons/percona-xtradb/setup/install) shows how to install and uninstall Percona XtraDB addon for Stash.
