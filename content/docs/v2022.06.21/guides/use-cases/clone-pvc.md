...
> **Note:** YAML files used in this tutorial are stored in [/docs/examples/guides/use-cases/clone-pvc](/docs/v2022.06.21/examples/guides/use-cases/clone-pvc) directory of [stashed/docs](https://github.com/stashed/docs) repository.
