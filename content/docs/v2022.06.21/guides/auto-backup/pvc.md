...
>**Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/auto-backup/pvc](/docs/v2022.06.21/examples/guides/auto-backup/pvc) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Backup data of PVC 'nfs-pvc' in GCS backend" src="/docs/v2022.06.21/images/guides/auto-backup/pvc/pvc_repo.png">
...
If you would like to uninstall Stash operator, please follow the steps [here](/docs/v2022.06.21/setup/README).
