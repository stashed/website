...
- Learn how to use Stash in Google Kubernetes Engine (GKE) from [here](/docs/0.8.1/guides/platforms/gke).
- Learn how to use Stash to backup a Kubernetes deployment from [here](/docs/0.8.1/guides/backup).
- Learn how to recover from backed up snapshot from [here](/docs/0.8.1/guides/restore).