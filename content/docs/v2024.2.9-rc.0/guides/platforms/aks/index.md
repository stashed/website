...
> **Note:** YAML files used in this tutorial are stored in  [docs/guides/platforms/aks/examples](/docs/v2024.2.9-rc.0/guides/platforms/aks/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Backup data in Azure Blob Storage Container" src="/docs/v2024.2.9-rc.0/guides/platforms/aks/images/aks.png">
...
1. See a step by step guide to backup/restore volumes of a StatefulSet [here](/docs/v2024.2.9-rc.0/guides/workloads/statefulset/).
2. See a step by step guide to backup/restore volumes of a DaemonSet [here](/docs/v2024.2.9-rc.0/guides/workloads/daemonset/).
3. See a step by step guide to Backup/restore Stand-alone PVC [here](/docs/v2024.2.9-rc.0/guides/volumes/pvc/)
