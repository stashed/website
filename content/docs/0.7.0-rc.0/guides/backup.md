...
you can create one by using [Minikube](https://github.com/kubernetes/minikube). Now, install Stash in your cluster following the steps [here](/docs/0.7.0-rc.0/setup/install).
...
If you would like to uninstall Stash operator, please follow the steps [here](/docs/0.7.0-rc.0/setup/uninstall).
