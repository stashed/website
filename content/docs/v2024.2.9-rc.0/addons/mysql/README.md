...
url: /docs/v2024.2.9-rc.0/addons/mysql/
aliases:
- /docs/v2024.2.9-rc.0/addons/mysql/README/
info:
  cli: v0.33.0-rc.0
...
- [How does it work?](/docs/v2024.2.9-rc.0/addons/mysql/overview/) gives an overview of how backup and restore process for MySQL database works in Stash.
- [Standalone MySQL Database](/docs/v2024.2.9-rc.0/addons/mysql/standalone/) shows how to backup and restore a standalone MySQL database.
