...
url: /docs/v2020.10.29/addons/percona-xtradb/
aliases:
- /docs/v2020.10.29/addons/percona-xtradb/README/
info:
  catalog: v2020.10.29
  cli: v0.11.4
  community: v0.11.4
...
{{< versionlist "percona-xtradb" "/docs/v2020.10.29/addons/percona-xtradb/guides/%s/clustered" >}}

## Documentation Overview

Stash Percona XtraDB documentations are organized as below:

- [How does it works?](/docs/v2020.10.29/addons/percona-xtradb/overview) gives an overview of how backup and restore process for Percona XtraDB database works in Stash.
- [Setup](/docs/v2020.10.29/addons/percona-xtradb/setup/install) shows how to install and uninstall Percona XtraDB addon for Stash.
- [Guides](/docs/v2020.10.29/addons/percona-xtradb/guides/5.7/clustered) contains step by step guides to backup and restore different versions of Percona XtraDB databases.
