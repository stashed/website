...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2021.10.11/images/v1alpha1/monitoring/prom-builtin-target.png" style="padding:10px">
</p>
...
To uninstall Stash follow this [guide](/docs/v2021.10.11/setup/README).

## Next Steps

- Learn how monitoring in Stash works from [here](/docs/v2021.10.11/guides/v1alpha1/monitoring/overview).
- Learn how to monitor Stash using Prometheus operator from [here](/docs/v2021.10.11/guides/v1alpha1/monitoring/coreos).
- Learn how to use Grafana dashboard to visualize monitoring data from [here](/docs/v2021.10.11/guides/v1alpha1/monitoring/grafana).
