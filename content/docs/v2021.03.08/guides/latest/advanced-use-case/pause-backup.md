...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/advanced-use-case/pause-backup](/docs/v2021.03.08/examples/guides/latest/advanced-use-case/pause-backup) directory of [stashed/doc](https://github.com/stashed/doc) repository.
