...
<figure align="center">
  <img alt="Percona XtraDB Backup Overview" src="/docs/v2022.06.27/addons/percona-xtradb/overview/images/backup_overview.svg">
...
<figure align="center">
 <img alt="Standalone Percona XtraDB Backup Overview" src="/docs/v2022.06.27/addons/percona-xtradb/overview/images/standalone_backup.png">
...
<figure align="center">
 <img alt="Percona XtraDB Cluster Backup Overview" src="/docs/v2022.06.27/addons/percona-xtradb/overview/images/cluster_backup.png">
...
<figure align="center">
  <img alt="Percona XtraDB Restore Overview" src="/docs/v2022.06.27/addons/percona-xtradb/overview/images/restore_overview.svg">
...
<figure align="center">
 <img alt="Standalone Percona XtraDB Restore Overview" src="/docs/v2022.06.27/addons/percona-xtradb/overview/images/standalone_restore.png">
...
<figure align="center">
 <img alt="Percona XtraDB Cluster Restore Overview" src="/docs/v2022.06.27/addons/percona-xtradb/overview/images/cluster_restore.png">
  <figcaption align="center">Fig: Percona XtraDB Cluster Restore</figcaption>
</figure>

## Next Steps

- Backup standalone Precona-XtraDB using Stash following the guide from [here](/docs/v2022.06.27/addons/percona-xtradb/standalone/).
- Backup Precona-XtraDB cluster using Stash following the guide from [here](/docs/v2022.06.27/addons/percona-xtradb/cluster/).
