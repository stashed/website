...
Stash Enterprise edition is the open core version of [Stash](https://github.com/stashed/stash). It comes with all the functionalities of Stash Community edition as well as some advanced features such as [Database Backup](/docs/v2023.08.14/guides/addons/overview/), [Auto-Backup](/docs/v2023.08.14/guides/auto-backup/overview/), [Batch Backup](/docs/v2023.08.14/guides/batch-backup/overview/), and [Local Backend](/docs/v2023.08.14/guides/backends/local/) support, etc. A full features comparison between Stash Enterprise Edition and community version can be found [here](/docs/v2023.08.14/concepts/what-is-stash/overview/).
