...
- If you are not familiar with how Stash backup and restore Etcd database, please check the following guide [here](/docs/v2022.05.12/addons/etcd/overview/).
...
This addon should be able to take backup of the databases with matching major versions as discussed in [Addon Version Compatibility](/docs/v2022.05.12/addons/etcd/README#addon-version-compatibility).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2022.05.12/addons/etcd/basic-auth/images/etcd-backup.jpg">
