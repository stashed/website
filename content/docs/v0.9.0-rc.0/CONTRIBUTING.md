...
url: /docs/v0.9.0-rc.0/welcome/contributing/
aliases:
- /docs/v0.9.0-rc.0/CONTRIBUTING/
info:
  version: v0.9.0-rc.0
---
...
We have a [Developer Guide](/docs/v0.9.0-rc.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your
