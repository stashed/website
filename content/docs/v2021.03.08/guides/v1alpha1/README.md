...
url: /docs/v2021.03.08/guides/v1alpha1/
aliases:
- /docs/v2021.03.08/guides/v1alpha1/README/
info:
  catalog: v2021.03.08
  cli: v0.11.10
  community: v0.11.10
...
- Learn to use Stash in Google Kubernetes Engine [here](/docs/v2021.03.08/guides/v1alpha1/platforms/gke)
- Learn to use Stash with self-hosted TLS secured Minio Server [here](/docs/v2021.03.08/guides/v1alpha1/platforms/minio).
- Learn to use Stash in Rook Storage System [here](/docs/v2021.03.08/guides/v1alpha1/platforms/rook)
