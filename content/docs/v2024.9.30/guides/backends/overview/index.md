...
You have to create a [Repository](/docs/v2024.9.30/concepts/crds/repository/) object which contains backend information and a `Secret` which contains necessary credentials to access the backend.
...
- Learn how to configure `OpenStack Swift` backend from [here](/docs/v2024.9.30/guides/backends/swift/).
- Learn how to configure `Backblaze B2` backend from [here](/docs/v2024.9.30/guides/backends/b2/).
- Learn how to configure `REST` backend from [here](/docs/v2024.9.30/guides/backends/rest/).
