...
Enable Prometheus monitoring using `prometheus.io/coreos-operator` agent while installing Stash. To know details about how to enable monitoring see [here](/docs/v2020.08.26-rc.1/guides/v1alpha1/monitoring/overview#how-to-enable-monitoring).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2020.08.26-rc.1/images/v1alpha1/monitoring/prom-coreos-target.png" style="padding:10px">
</p>
...
- Learn how to use Grafana dashboard to visualize monitoring data from [here](/docs/v2020.08.26-rc.1/guides/v1alpha1/monitoring/grafana).
