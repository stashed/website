...
- [KubeDB managed Elasticsearch](/docs/v2025.2.10/addons/elasticsearch/kubedb/) shows how to backup and restore a KubeDB managed Elasticsearch database.
- [Auto-Backup](/docs/v2025.2.10/addons/elasticsearch/auto-backup/) shows how to configure a generic backup template for all the Elasticsearch databases of a cluster.
- [Customizing Backup & Restore Process](/docs/v2025.2.10/addons/elasticsearch/customization/) shows how to customize the backup & restore process.
