...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/volumes](/docs/v2022.05.12/examples/guides/volumes) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Backed up data of a stand-alone PVC in GCS backend" src="/docs/v2022.05.12/images/guides/volumes/pvc_repo.png">
