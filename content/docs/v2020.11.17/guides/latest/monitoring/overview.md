...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v2020.11.17/images/guides/latest/monitoring/stash-monitoring-structure.svg">
...
- Learn how to monitor Stash using built-in Prometheus from [here](/docs/v2020.11.17/guides/latest/monitoring/builtin).
