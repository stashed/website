...
- Learn how to use Stash to backup workloads data from [here](/docs/v2020.10.30/guides/latest/workloads/overview).
- Learn how to use Stash to backup databases from [here](/docs/v2020.10.30/guides/latest/addons/overview).
- Learn how to use Stash to backup stand-alone PVC from [here](/docs/v2020.10.30/guides/latest/volumes/overview).
