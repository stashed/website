...
menu:
  docs_v2021.03.11:
    identifier: mariadb-guide-10.5.8-v1-kubedb-standalone
    name: Standalone MariaDB
    parent: stash-mariadb-guides-10.5.8-v1-kubedb
    weight: 10
product_name: stash
...
- Install MariaDB addon for Stash following the steps [here](/docs/v2021.03.11/addons/mariadb/setup/install).
- Install KubeDB operator in your cluster from [here](https://kubedb.com/docs/latest/setup).
- If you are not familiar with how Stash backup and restore MariaDB databases, please check the following guide [here](/docs/v2021.03.11/addons/mariadb/overview).
...
At first, make sure that you have installed Stash MariaDB addon version {{< param "info.subproject_version" >}}. If haven't install the addon yet, install it by following the setup guide from [here](/docs/v2021.03.11/addons/mariadb/setup/install).
...
This addon should be able to take backup of the databases with matching major versions as discussed in [Addon Version Compatibility](/docs/v2021.03.11/addons/mariadb/README#addon-version-compatibility).
...
We are going to store our backed up data into a GCS bucket. So, we need to create a Secret with GCS credentials and a `Repository` object with the bucket information. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2021.03.11/guides/latest/backends/overview).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.11/addons/mariadb/guides/{{< param "info.subproject_version" >}}/kubedb/standalone/images/sample-mariadb-backup.png">
