...
Stash 0.9.0+ supports taking backup multiple co-related components using a single configuration known as [BackupBatch](/docs/v0.9.0-rc.4/concepts/crds/backupbatch). This guide will give you an overview how batch backup works in Stash.
...
<figure align="center">
  <img alt="Stash Batch Backup Flow" src="/docs/v0.9.0-rc.4/images/guides/latest/batch-backup/batchbackup_overview.svg">
...
- See a step by step guide to backup application with multiple co-related components [here](/docs/v0.9.0-rc.4/guides/latest/batch-backup/batch-backup).