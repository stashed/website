...
<figure align="center">
  <img alt="KubeDump Backup Overview" src="/docs/v2023.01.05/addons/kubedump/overview/images/kubedump-backup.svg">
...
- Backup the YAMLs of your entire Kubernetes cluster using Stash following the guide from [here](/docs/v2023.01.05/addons/kubedump/cluster/).
- Backup the YAMLs of an entire Namespace using Stash following the guide from [here](/docs/v2023.01.05/addons/kubedump/namespace/).
- Backup the YAMLs of a particular application using Stash following the guide from [here](/docs/v2023.01.05/addons/kubedump/application/).
