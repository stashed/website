...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/workloads/daemonset/examples](/docs/v2025.10.17/guides/workloads/daemonset/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
