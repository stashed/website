...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v2020.11.17/images/guides/latest/monitoring/prom-builtin-target.png">
<figcaption align="center">Fig: Prometheus dashboard</figcaption>
</figure>

**Backup and Restore Metrics:**

When you perform a backup or restore using Stash, it will send respective Prometheus metrics. You can check if the metrics have been sent successfully by performing backup and restore as described [here](/docs/v2020.11.17/guides/latest/workloads/deployment).

A screenshot that shows Prometheus metrics send by Stash backup and restore process is given below,

<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v2020.11.17/images/guides/latest/monitoring/prometheus_backup_restore_met.png">
...
To uninstall Stash follow this [guide](/docs/v2020.11.17/setup/README).

## Next Steps

- Learn how monitoring in Stash works from [here](/docs/v2020.11.17/guides/latest/monitoring/overview).
- Learn how to monitor Stash using Prometheus operator from [here](/docs/v2020.11.17/guides/latest/monitoring/coreos).
