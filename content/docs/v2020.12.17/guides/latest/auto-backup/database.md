...
- Install PostgreSQL addon for Stash following the steps [here](/docs/v2020.12.17/addons/postgres/setup/install).
...
- If you are not familiar with how Stash backup and restore PostgreSQL databases, please check the following guide [here](/docs/v2020.12.17/addons/postgres/overview).
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/auto-backup/database](/docs/v2020.12.17/examples/guides/latest/auto-backup/database) directory of [stashed/docs](https://github.com/stashed/docs) repository.

## Prepare Backup Blueprint

We are going to use [GCS Backend](/docs/v2020.12.17/guides/latest/backends/gcs) to store the backed up data. You can use any supported backend you prefer. You just have to configure Storage Secret and `spec.backend` section of `BackupBlueprint` to match with your backend. To learn which backends are supported by Stash and how to configure them, please visit [here](/docs/v2020.12.17/guides/latest/backends/overview).
...
<figure align="center">
  <img alt="Backup data of PostgreSQL 'sample-postgres-1' in GCS backend" src="/docs/v2020.12.17/images/guides/latest/auto-backup/database/sample_postgres_1.png">
...
<figure align="center">
  <img alt="Backup data of PostgreSQL 'sample-postgres-2' in GCS backend" src="/docs/v2020.12.17/images/guides/latest/auto-backup/database/sample_postgres_2.png">
