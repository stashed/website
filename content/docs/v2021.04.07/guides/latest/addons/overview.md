...
A Stash addon is a collection of [Functions](/docs/v2021.04.07/concepts/crds/function) and a [Task](/docs/v2021.04.07/concepts/crds/task) to backup & restore a specific resource.
...
<figure align="center">
  <img alt="Stash Addon Overview" src="/docs/v2021.04.07/images/guides/latest/addons/addon_overview.svg">
...
The following addons are available for [Stash Enterprise Edition](/docs/v2021.04.07/setup/install/enterprise):
