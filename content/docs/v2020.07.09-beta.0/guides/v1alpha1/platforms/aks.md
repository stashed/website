...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/aks](/docs/v2020.07.09-beta.0/examples/platforms/aks) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<p align="center">
  <img alt="Repository in Azure Backend",  height="350px" src="/docs/v2020.07.09-beta.0/images/v1alpha1/platforms/aks/azure-backup-repository.png">
</p>

To view the snapshot files, navigate to `snapshots` directory of the repository,

<p align="center">
  <img alt="Snapshot in Azure Bucket" height="350px" src="/docs/v2020.07.09-beta.0/images/v1alpha1/platforms/aks/azure-backup-snapshots.png">
</p>
