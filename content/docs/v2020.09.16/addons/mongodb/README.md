...
url: /docs/v2020.09.16/addons/mongodb/
aliases:
- /docs/v2020.09.16/addons/mongodb/README/
info:
  catalog: v2020.09.16
  cli: v0.11.0
  community: v0.11.0
...
{{< versionlist "mongodb" "/docs/v2020.09.16/addons/mongodb/guides/%s/mongodb" >}}
...
- [How does it works?](/docs/v2020.09.16/addons/mongodb/overview) gives an overview of how backup and restore process for MongoDB database works in Stash.
- [Setup](/docs/v2020.09.16/addons/mongodb/setup/install) shows how to install and uninstall MongoDB addon for Stash.
- [Guides](/docs/v2020.09.16/addons/mongodb/guides/3.6/mongodb) contains step by step guides to backup and restore different versions of MongoDB databases.
