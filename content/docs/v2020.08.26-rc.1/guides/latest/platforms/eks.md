...
> **Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/latest/platforms/eks](/docs/v2020.08.26-rc.1/examples/guides/latest/platforms/eks) directory of [stashed/doc](https://github.com/stashed/doc) repository.
...
<figure align="center">
  <img alt="Backup data in AWS s3 Bucket" src="/docs/v2020.08.26-rc.1/images/guides/latest/platforms/eks.png">
