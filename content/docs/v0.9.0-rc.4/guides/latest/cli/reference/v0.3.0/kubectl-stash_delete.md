...
menu:
  docs_v0.9.0-rc.4:
    identifier: kubectl-stash-delete-v0.3.0
    name: Delete
...
* [kubectl-stash delete snapshot](/docs/v0.9.0-rc.4/guides/latest/cli/reference/{{< param "info.subproject_version" >}}/kubectl-stash_delete_snapshot)	 - Delete a snapshot from repository backend
