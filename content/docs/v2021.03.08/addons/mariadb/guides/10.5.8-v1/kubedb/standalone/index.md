...
- Install MariaDB addon for Stash following the steps [here](/docs/v2021.03.08/addons/mariadb/setup/install).
...
At first, make sure that you have installed Stash MariaDB addon version {{< param "info.subproject_version" >}}. If haven't install the addon yet, install it by following the setup guide from [here](/docs/v2021.03.08/addons/mariadb/setup/install).
...
This addon should be able to take backup of the databases with matching major versions as discussed in [Addon Version Compatibility](/docs/v2021.03.08/addons/mariadb/README#addon-version-compatibility).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.08/addons/mariadb/guides/{{< param "info.subproject_version" >}}/kubedb/standalone/images/sample-mariadb-backup.png">
