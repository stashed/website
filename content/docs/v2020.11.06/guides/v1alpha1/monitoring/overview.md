...
<p align="center">
  <img alt="Monitoring Structure"  src="/docs/v2020.11.06/images/v1alpha1/monitoring/stash-monitoring-structure.png">
</p>
...
- Learn how to monitor Stash using built-in Prometheus from [here](/docs/v2020.11.06/guides/v1alpha1/monitoring/builtin).
