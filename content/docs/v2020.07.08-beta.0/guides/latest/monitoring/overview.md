...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v2020.07.08-beta.0/images/guides/latest/monitoring/stash-monitoring-structure.svg">
...
- Learn how to monitor Stash using built-in Prometheus from [here](/docs/v2020.07.08-beta.0/guides/latest/monitoring/builtin).
