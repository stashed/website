...
- You should be familiar with the following `Stash` concepts:
  - [BackupBlueprint](/docs/v2021.08.02/concepts/crds/backupblueprint)
...
>**Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/latest/auto-backup/pvc](/docs/v2021.08.02/examples/guides/latest/auto-backup/pvc) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
We are going to use [GCS Backend](/docs/v2021.08.02/guides/latest/backends/gcs) to store the backed up data. You can use any supported backend you prefer. You just have to configure Storage Secret and `spec.backend` section of `BackupBlueprint` to match your backend. To learn which backends are supported by Stash and how to configure them, please visit [here](/docs/v2021.08.02/guides/latest/backends/overview).

> For GCS backend, if the bucket does not exist, Stash needs `Storage Object Admin` role permissions to create the bucket. For more details, please check the following [guide](/docs/v2021.08.02/guides/latest/backends/gcs).
...
<figure align="center">
  <img alt="Backup data of PVC 'nfs-pvc' in GCS backend" src="/docs/v2021.08.02/images/guides/latest/auto-backup/pvc/pvc_repo.png">
...
If you would like to uninstall Stash operator, please follow the steps [here](/docs/v2021.08.02/setup/README).
