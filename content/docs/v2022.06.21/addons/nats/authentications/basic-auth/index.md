...
- If you are not familiar with how Stash backup and restore NATS streams, please check the following guide [here](/docs/v2022.06.21/addons/nats/overview/).
...
This addon should be able to take backup of the NATS streams with matching major versions as discussed in [Addon Version Compatibility](/docs/v2022.06.21/addons/nats/README#addon-version-compatibility).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2022.06.21/addons/nats/authentications/basic-auth/images/sample-nats-backup.png">
