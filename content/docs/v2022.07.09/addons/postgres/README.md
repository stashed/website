...
url: /docs/v2022.07.09/addons/postgres/
aliases:
- /docs/v2022.07.09/addons/postgres/README/
info:
  cli: v0.22.0
  community: v0.22.0
  elasticsearch:
...
- [How does it work?](/docs/v2022.07.09/addons/postgres/overview/) gives an overview of how backup and restore process for PostgreSQL database works in Stash.
- [Standalone PostgreSQL](/docs/v2022.07.09/addons/postgres/standalone/) shows how to backup and restore a standalone PostgreSQL database using Stash.
- [Auto-Backup](/docs/v2022.07.09/addons/postgres/auto-backup/) shows how to configure a generic backup template for all the PostgreSQL databases of a cluster.
