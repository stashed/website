...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/platforms/rook](/docs/v2022.03.29/examples/guides/platforms/rook) directory of [stashed/doc](https://github.com/stashed/doc) repository.
