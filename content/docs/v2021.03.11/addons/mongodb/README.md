...
url: /docs/v2021.03.11/addons/mongodb/
aliases:
- /docs/v2021.03.11/addons/mongodb/README/
info:
  catalog: v2021.03.11
  cli: v0.11.11
  community: v0.11.11
...
{{< versionlist "mongodb" "/docs/v2021.03.11/addons/mongodb/guides/%s/mongodb" >}}
...
- [How does it works?](/docs/v2021.03.11/addons/mongodb/overview) gives an overview of how backup and restore process for MongoDB database works in Stash.
- [Setup](/docs/v2021.03.11/addons/mongodb/setup/install) shows how to install and uninstall MongoDB addon for Stash.
