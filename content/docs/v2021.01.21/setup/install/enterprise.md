...
Stash Enterprise edition is the open core version of [Stash](https://github.com/stashed/stash). It comes with all the functionalities of Stash Community edition as well as some advanced features such as [Auto-Backup](/docs/v2021.01.21/guides/latest/auto-backup/overview), [Batch Backup](/docs/v2021.01.21/guides/latest/batch-backup/overview), and [Local Backend](/docs/v2021.01.21/guides/latest/backends/local) support, etc. A full features comparison between Stash Enterprise Edition and community version can be found [here](/docs/v2021.01.21/concepts/what-is-stash/overview).
...
<figure align="center">
  <img alt="Stash Backend Overview" src="/docs/v2021.01.21/images/setup/enterprise_license_form.png">
