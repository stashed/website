...
menu:
  docs_v2021.03.11:
    identifier: mongodb-replicaset-3.4.22-v6
...
KubeDB creates an [AppBinding](/docs/v2021.03.11/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
