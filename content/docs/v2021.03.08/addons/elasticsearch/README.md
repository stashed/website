...
url: /docs/v2021.03.08/addons/elasticsearch/
aliases:
- /docs/v2021.03.08/addons/elasticsearch/README/
info:
  catalog: v2021.03.08
  cli: v0.11.10
  community: v0.11.10
...
{{< versionlist "elasticsearch" "/docs/v2021.03.08/addons/elasticsearch/guides/%s/elasticsearch" >}}
...
- [How does it works?](/docs/v2021.03.08/addons/elasticsearch/overview) gives an overview of how backup and restore process for Elasticsearch database works in Stash.
- [Setup](/docs/v2021.03.08/addons/elasticsearch/setup/install) shows how to install and uninstall Elasticsearch addon for Stash.
