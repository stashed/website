...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/platforms/rook/examples](/docs/v2025.6.30/guides/platforms/rook/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
