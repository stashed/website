...
<figure align="center">
  <img alt="PostgreSQL Backup Overview" src="/docs/v0.9.0-rc.2/images/addons/postgres/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v0.9.0-rc.2/images/addons/postgres/restore_overview.svg">
...
- Install PostgreSQL addon for Stash following the guide from [here](/docs/v0.9.0-rc.2/addons/postgres/setup/install).
