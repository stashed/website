...
<figure align="center">
  <img alt="Percona XtraDB Backup Overview" src="/docs/v2020.07.08-beta.0/images/addons/percona-xtradb/backup_overview.svg">
...
<figure align="center">
 <img alt="Standalone Percona XtraDB Backup Overview" src="/docs/v2020.07.08-beta.0/images/addons/percona-xtradb/standalone_backup.png">
...
<figure align="center">
 <img alt="Percona XtraDB Cluster Backup Overview" src="/docs/v2020.07.08-beta.0/images/addons/percona-xtradb/cluster_backup.png">
...
<figure align="center">
  <img alt="Percona XtraDB Restore Overview" src="/docs/v2020.07.08-beta.0/images/addons/percona-xtradb/restore_overview.svg">
...
<figure align="center">
 <img alt="Standalone Percona XtraDB Restore Overview" src="/docs/v2020.07.08-beta.0/images/addons/percona-xtradb/standalone_restore.png">
...
<figure align="center">
 <img alt="Percona XtraDB Cluster Restore Overview" src="/docs/v2020.07.08-beta.0/images/addons/percona-xtradb/cluster_restore.png">
  <figcaption align="center">Fig: Percona XtraDB Cluster Restore</figcaption>
</figure>

## Next Steps

- Install Percona XtraDB addon for Stash following the guide from [here](/docs/v2020.07.08-beta.0/addons/percona-xtradb/setup/install).
