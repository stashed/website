...
You can find the full working demo in [examples folder](/docs/v0.9.0-rc.2/examples/workloads/statefulset.yaml). The section you should change for your own StatefulSet are:
...
- Wondering what features are coming next? Please visit [here](/docs/v0.9.0-rc.2/roadmap).
