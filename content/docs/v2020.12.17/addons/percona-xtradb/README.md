...
url: /docs/v2020.12.17/addons/percona-xtradb/
aliases:
- /docs/v2020.12.17/addons/percona-xtradb/README/
info:
  catalog: v2020.12.17
  cli: v0.11.8
  community: v0.11.8
...
{{< versionlist "percona-xtradb" "/docs/v2020.12.17/addons/percona-xtradb/guides/%s/clustered" >}}
...
- [How does it works?](/docs/v2020.12.17/addons/percona-xtradb/overview) gives an overview of how backup and restore process for Percona XtraDB database works in Stash.
- [Setup](/docs/v2020.12.17/addons/percona-xtradb/setup/install) shows how to install and uninstall Percona XtraDB addon for Stash.
