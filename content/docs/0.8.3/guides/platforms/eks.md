...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/eks](/docs/0.8.3/examples/platforms/eks) directory of [appscode/stash](https://github.com/appscode/stash) repository.
...
<p align="center">
  <img alt="Repository in AWS S3 Backend",  height="350px" src="/docs/0.8.3/images/platforms/eks/s3-backup-repository.png">
</p>

To view the snapshot files, navigate to `snapshots` directory of the repository,

<p align="center">
  <img alt="Snapshot in AWS S3 Bucket" height="350px" src="/docs/0.8.3/images/platforms/eks/s3-backup-snapshots.png">
</p>
