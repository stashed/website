...
Enable Prometheus monitoring using `prometheus.io/coreos-operator` agent while installing Stash. To know details about how to enable monitoring see [here](/docs/0.8.2/guides/monitoring/overview#how-to-enable-monitoring).
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/0.8.2/images/monitoring/prom-coreos-target.png" style="padding:10px">
</p>
...
To uninstall Stash follow this [guide](/docs/0.8.2/setup/uninstall).
