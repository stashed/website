...
menu:
  docs_v0.9.0-rc.6:
    identifier: kubectl-stash-clone-v0.3.1
    name: Clone
...
* [kubectl-stash clone pvc](/docs/v0.9.0-rc.6/guides/latest/cli/reference/{{< param "info.subproject_version" >}}/kubectl-stash_clone_pvc)	 - Clone PVC
