...
- Learn how to use Stash in Google Kubernetes Engine (GKE) from [here](/docs/v2021.03.11/guides/v1alpha1/platforms/gke).
- Learn how to use Stash to backup a Kubernetes deployment from [here](/docs/v2021.03.11/guides/v1alpha1/backup).
- Learn how to recover from backed up snapshot from [here](/docs/v2021.03.11/guides/v1alpha1/restore).
