...
url: /docs/v2021.04.07/addons/mysql/
aliases:
- /docs/v2021.04.07/addons/mysql/README/
info:
  cli: v0.12.1
  community: v0.12.1
  elasticsearch:
...
- [How does it works?](/docs/v2021.04.07/addons/mysql/overview/) gives an overview of how backup and restore process for MySQL database works in Stash.
- [Standalone MySQL Database](/docs/v2021.04.07/addons/mysql/standalone/) shows how to backup and restore a standalone MySQL database.
