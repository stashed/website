...
Stash Community edition is available under [AppsCode-Community-1.0.0](https://github.com/appscode/licenses/raw/1.0.0/AppsCode-Community-1.0.0.md) license and free to use for both commercial and non-commercial purposes. It comes with all the basic backup functionalities. However, it lacks some advanced features such as [Database Backup](/docs/v2020.11.17/guides/latest/addons/overview), [Auto-Backup](/docs/v2020.11.17/guides/latest/auto-backup/overview), [Batch Backup](/docs/v2020.11.17/guides/latest/batch-backup/overview), and [Local Backend](/docs/v2020.11.17/guides/latest/backends/local) support, etc. compared to the Enterprise edition. A full features comparison between the Stash Community edition and Enterprise edition can be found [here](/docs/v2020.11.17/concepts/what-is-stash/overview).
...
<figure align="center">
  <img alt="Stash Backend Overview" src="/docs/v2020.11.17/images/setup/community_license_form.png">
  <figcaption align="center">Fig: Stash License Form</figcaption>
</figure>

You can create licenses for as many clusters as you want. You can upgrade your license any time without re-installing Stash by following the upgrading guide from [here](/docs/v2020.11.17/setup/upgrade#upgrading-license).
...
Now, you are ready to [take your first backup](/docs/v2020.11.17/guides/latest/README) using Stash.
