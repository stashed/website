...
> **Note:** YAML files used in this tutorial are stored in [/docs/examples/guides/latest/advanced-use-case/clone-pvc](/docs/v2021.03.17/examples/guides/latest/advanced-use-case/clone-pvc) directory of [stashed/docs](https://github.com/stashed/docs) repository.
