...
<p align="center">
  <img alt="Monitoring Structure"  src="/docs/v0.9.0-rc.2/images/v1alpha1/monitoring/stash-monitoring-structure.png">
</p>
...
- Learn how to monitor Stash using built-in Prometheus from [here](/docs/v0.9.0-rc.2/guides/v1alpha1/monitoring/builtin).
