...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v2021.11.24/guides/latest/monitoring/overview/images/monitoring-structure.svg">
...
The following instruction show example of enabling monitoring in Stash for the Prometheus server deployed with Prometheus Operator. You can check the [Builtin Prometheus](/docs/v2021.11.24/guides/latest/monitoring/prom-builtin/) scraper guide if you are managing your Prometheus server manually.
