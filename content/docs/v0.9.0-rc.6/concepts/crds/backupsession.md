...
- Learn how backup of workloads data works from [here](/docs/v0.9.0-rc.6/guides/latest/workloads/overview).
- Learn how backup of databases works from [here](/docs/v0.9.0-rc.6/guides/latest/addons/overview).
- Learn how backup stand alone PVC works from [here](/docs/v0.9.0-rc.6/guides/latest/volumes/overview).
