...
# Restore Backup
This tutorial will show you how to restore a Stash backup. At first, backup a kubernetes workload volume by following the steps [here](/docs/0.7.0/guides/backup).
...
With the help of [Snapshot](/docs/0.7.0/concepts/crds/snapshot) object, stash allows the users to recover a particular snapshot. Now, the users can specify which snapshot to recover. Here, is an example of how to recover a specific snapshot.
