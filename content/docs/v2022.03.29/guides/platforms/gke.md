...
- You should be familiar with the following `Stash` concepts:
  ...
  - [RestoreSession](/docs/v2022.03.29/concepts/crds/restoresession)
...
> **Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/platforms/gke](/docs/v2022.03.29/examples/guides/platforms/gke) directory of [stashed/doc](https://github.com/stashed/doc) repository.
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2022.03.29/images/guides/platforms/gke.png">
...
1. See a step by step guide to backup/restore volumes of a StatefulSet [here](/docs/v2022.03.29/guides/workloads/statefulset).
2. See a step by step guide to backup/restore volumes of a DaemonSet [here](/docs/v2022.03.29/guides/workloads/daemonset).
3. See a step by step guide to Backup/restore Stand-alone PVC [here](/docs/v2022.03.29/guides/volumes/pvc)
