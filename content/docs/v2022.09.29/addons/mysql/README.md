...
url: /docs/v2022.09.29/addons/mysql/
aliases:
- /docs/v2022.09.29/addons/mysql/README/
info:
  cli: v0.23.0
  community: v0.23.0
  elasticsearch:
...
- [How does it work?](/docs/v2022.09.29/addons/mysql/overview/) gives an overview of how backup and restore process for MySQL database works in Stash.
- [Standalone MySQL Database](/docs/v2022.09.29/addons/mysql/standalone/) shows how to backup and restore a standalone MySQL database.
