...
At first, you need to have a Kubernetes cluster in Google Cloud Platform. If you don't already have a cluster, you can create one from [here](https://console.cloud.google.com/kubernetes). Now, install Stash in your cluster following the steps [here](/docs/0.7.0-rc.5/setup/install).
...
Now, let’s backup the directory into a [GCS bucket](/docs/0.7.0-rc.5/guides/backends#google-cloud-storage-gcs),
...
Delete the disk created here from Google Cloud console. Uninstall Stash following the instructions [here](/docs/0.7.0-rc.5/setup/uninstall).
