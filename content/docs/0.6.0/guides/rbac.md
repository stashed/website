...
To use Stash in a RBAC enabled cluster, [install Stash](/docs/0.6.0/setup/install) with RBAC options. This creates a ClusterRole named `stash-sidecar`.
...
You can find full working examples [here](/docs/0.6.0/guides/workloads).
