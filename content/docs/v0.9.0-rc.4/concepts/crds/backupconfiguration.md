...
`spec.task` specifies the name and parameters of the [Task](/docs/v0.9.0-rc.4/concepts/crds/task) crd to use to backup the target.
...
- Learn how to configure `BackupConfiguration` to backup workloads data from [here](/docs/v0.9.0-rc.4/guides/latest/workloads/overview).
- Learn how to configure `BackupConfiguration` to backup databases from [here](/docs/v0.9.0-rc.4/guides/latest/addons/overview).
- Learn how to configure `BackupConfiguration` to backup stand-alone PVC from [here](/docs/v0.9.0-rc.4/guides/latest/volumes/overview).
