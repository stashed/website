...
url: /docs/v2021.01.21/addons/mysql/
aliases:
- /docs/v2021.01.21/addons/mysql/README/
info:
  catalog: v2021.01.21
  cli: v0.11.9
  community: v0.11.9
...
{{< versionlist "mysql" "/docs/v2021.01.21/addons/mysql/guides/%s/mysql" >}}
...
- [How does it works?](/docs/v2021.01.21/addons/mysql/overview) gives an overview of how backup and restore process for MySQL database works in Stash.
- [Setup](/docs/v2021.01.21/addons/mysql/setup/install) shows how to install and uninstall MySQL addon for Stash.
