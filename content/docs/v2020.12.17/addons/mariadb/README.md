...
url: /docs/v2020.12.17/addons/mariadb/
aliases:
- /docs/v2020.12.17/addons/mariadb/README/
info:
  catalog: v2020.12.17
  cli: v0.11.8
  community: v0.11.8
...
{{< versionlist "mariadb" "/docs/v2020.12.17/addons/mariadb/guides/%s/helm/logical" >}}
...
- [How does it works?](/docs/v2020.12.17/addons/mariadb/overview) gives an overview of how backup and restore process for MariaDB database works in Stash.
- [Setup](/docs/v2020.12.17/addons/mariadb/setup/install) shows how to install and uninstall MariaDB addon for Stash.
