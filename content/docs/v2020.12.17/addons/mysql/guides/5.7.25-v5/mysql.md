...
menu:
  docs_v2020.12.17:
    identifier: mysql-guide-5.7.25-v5
    name: Backup & Restore MySQL
    parent: stash-mysql-guides-5.7.25-v5
    weight: 10
product_name: stash
...
Here, we have to use service `sample-mysql` and secret `sample-mysql-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2020.12.17/concepts/crds/appbinding) CRD that holds the necessary information to connect with the database.
