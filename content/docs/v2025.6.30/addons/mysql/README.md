...
- [How does it work?](/docs/v2025.6.30/addons/mysql/overview/) gives an overview of how backup and restore process for MySQL database works in Stash.
- [Standalone MySQL Database](/docs/v2025.6.30/addons/mysql/standalone/) shows how to backup and restore a standalone MySQL database.
