...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2025.1.9/guides/volumesnapshot/overview/images/volumesnapshot-overview.svg">
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2025.1.9/guides/volumesnapshot/overview/images/restore-overview.svg">
...
1. See a step by step guide to snapshot the volumes of a Deployment [here](/docs/v2025.1.9/guides/volumesnapshot/deployment/).
2. See a step by step guide to snapshot the volumes of a StatefulSet [here](/docs/v2025.1.9/guides/volumesnapshot/statefulset/).
3. See a step by step guide to snapshot a stand-alone PVC [here](/docs/v2025.1.9/guides/volumesnapshot/pvc/).
