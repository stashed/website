...
url: /docs/0.7.0-rc.3/welcome/contributing/
aliases:
- /docs/0.7.0-rc.3/CONTRIBUTING/
info:
  version: 0.7.0-rc.3
---
...
We have a [Developer Guide](/docs/0.7.0-rc.3/setup/developer-guide/overview) that outlines everything you need to know from setting up your
