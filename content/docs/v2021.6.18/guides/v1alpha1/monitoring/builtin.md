...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2021.6.18/images/v1alpha1/monitoring/prom-builtin-target.png" style="padding:10px">
</p>
...
- Learn how to monitor Stash using Prometheus operator from [here](/docs/v2021.6.18/guides/v1alpha1/monitoring/coreos).
- Learn how to use Grafana dashboard to visualize monitoring data from [here](/docs/v2021.6.18/guides/v1alpha1/monitoring/grafana).
