...
To use Stash in a RBAC enabled cluster, [install Stash](/docs/0.7.0-rc.3/setup/install) with RBAC options. This creates a ClusterRole named `stash-sidecar`.
...
You can find full working examples [here](/docs/0.7.0-rc.3/guides/workloads).
