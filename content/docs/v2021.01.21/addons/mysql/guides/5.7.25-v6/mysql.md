...
menu:
  docs_v2021.01.21:
    identifier: mysql-guide-5.7.25-v6
    name: Backup & Restore MySQL
    parent: stash-mysql-guides-5.7.25-v6
    weight: 10
product_name: stash
...
Here, we have to use service `sample-mysql` and secret `sample-mysql-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2021.01.21/concepts/crds/appbinding) CRD that holds the necessary information to connect with the database.
