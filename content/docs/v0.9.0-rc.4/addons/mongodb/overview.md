...
<figure align="center">
 <img alt="MongoDB Backup Overview" src="/docs/v0.9.0-rc.4/images/addons/mongodb/backup_overview.svg">
...
<figure align="center">
 <img alt="Standalone MongoDB Backup Overview" src="/docs/v0.9.0-rc.4/images/addons/mongodb/standalone_backup.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Backup Overview" src="/docs/v0.9.0-rc.4/images/addons/mongodb/replicaset_backup.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Backup Overview" src="/docs/v0.9.0-rc.4/images/addons/mongodb/sharded_backup.svg">
...
<figure align="center">
 <img alt="Database Restore Overview" src="/docs/v0.9.0-rc.4/images/addons/mongodb/restore_overview.svg">
...
<figure align="center">
 <img alt="Standalone MongoDB Restore Overview" src="/docs/v0.9.0-rc.4/images/addons/mongodb/standalone_restore.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Restore Overview" src="/docs/v0.9.0-rc.4/images/addons/mongodb/replicaset_restore.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Restore" src="/docs/v0.9.0-rc.4/images/addons/mongodb/sharded_restore.svg">
  <figcaption align="center">Fig: MongoDB Sharded Cluster Restore</figcaption>
</figure>

## Next Steps

- Install MongoDB addon for Stash following the guide from [here](/docs/v0.9.0-rc.4/addons/mongodb/setup/install).
