...
> Note: YAML files used in this tutorial are stored in [/docs/guides/volumesnapshot/deployment/examples](/docs/v2024.4.8/guides/volumesnapshot/deployment/examples/) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Stash Backup Flow" src="/docs/v2024.4.8/guides/volumesnapshot/deployment/images/gcp.png">
