...
url: /docs/v2022.06.21/addons/mariadb/
aliases:
- /docs/v2022.06.21/addons/mariadb/README/
info:
  cli: v0.21.0
  community: v0.21.0
  elasticsearch:
...
- [How does it work?](/docs/v2022.06.21/addons/mariadb/overview/) gives an overview of how backup and restore process for MariaDB database works in Stash.
- [Helm managed MariaDB](/docs/v2022.06.21/addons/mariadb/helm/) shows how to backup and restore a Helm managed MariaDB database.
- [Auto-Backup](/docs/v2022.06.21/addons/mariadb/auto-backup/) shows how to configure a generic backup template for all the MariaDB databases of a cluster.
- [Customizing Backup & Restore Process](/docs/v2022.06.21/addons/mariadb/customization/) shows how to customize the backup & restore process.
