...
url: /docs/v2021.03.08/addons/mariadb/
aliases:
- /docs/v2021.03.08/addons/mariadb/README/
info:
  catalog: v2021.03.08
  cli: v0.11.10
  community: v0.11.10
...
{{< versionlist "mariadb" "/docs/v2021.03.08/addons/mariadb/guides/%s/helm/logical" >}}
...
- [How does it works?](/docs/v2021.03.08/addons/mariadb/overview) gives an overview of how backup and restore process for MariaDB database works in Stash.
- [Setup](/docs/v2021.03.08/addons/mariadb/setup/install) shows how to install and uninstall MariaDB addon for Stash.
