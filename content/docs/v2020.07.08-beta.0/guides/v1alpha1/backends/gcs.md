...
- Learn how to use Stash in Google Kubernetes Engine (GKE) from [here](/docs/v2020.07.08-beta.0/guides/v1alpha1/platforms/gke).
- Learn how to use Stash to backup a Kubernetes deployment from [here](/docs/v2020.07.08-beta.0/guides/v1alpha1/backup).
- Learn how to recover from backed up snapshot from [here](/docs/v2020.07.08-beta.0/guides/v1alpha1/restore).
