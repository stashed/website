...
Uninstall old `Stash` operator by following the instructions [here](/docs/0.6.0/setup/uninstall).
...
Install new `Stash` operator by following the instructions [here](/docs/0.6.0/setup/install).
