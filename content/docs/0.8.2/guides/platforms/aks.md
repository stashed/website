...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/aks](/docs/0.8.2/examples/platforms/aks) directory of [appscode/stash](https://github.com/appscode/stash) repository.
...
<p align="center">
  <img alt="Repository in Azure Backend",  height="350px" src="/docs/0.8.2/images/platforms/aks/azure-backup-repository.png">
</p>

To view the snapshot files, navigate to `snapshots` directory of the repository,

<p align="center">
  <img alt="Snapshot in Azure Bucket" height="350px" src="/docs/0.8.2/images/platforms/aks/azure-backup-snapshots.png">
</p>
