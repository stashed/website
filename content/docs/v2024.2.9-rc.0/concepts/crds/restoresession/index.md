...
`spec.task` specifies the name and parameters of the [Task](/docs/v2024.2.9-rc.0/concepts/crds/task/) crd to use to restore the target data.
...
- Learn how restore of workloads data works from [here](/docs/v2024.2.9-rc.0/guides/workloads/overview/).
- Learn how restore of databases works from [here](/docs/v2024.2.9-rc.0/guides/addons/overview/).
- Learn how restore stand-alone PVC works from [here](/docs/v2024.2.9-rc.0/guides/volumes/overview/).
