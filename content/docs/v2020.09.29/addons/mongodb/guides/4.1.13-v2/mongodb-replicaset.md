...
menu:
  docs_v2020.09.29:
    identifier: mongodb-replicaset-4.1.13-v2
...
KubeDB creates an [AppBinding](/docs/v2020.09.29/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
