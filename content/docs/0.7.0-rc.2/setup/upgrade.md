...
If you are upgrading Stash to a patch release, please reapply the [installation instructions](/docs/0.7.0-rc.2/setup/install). That will upgrade the operator pod to the new version and fix any RBAC issues.
...
Uninstall old `Stash` operator by following the instructions [here](/docs/0.7.0-rc.2/setup/uninstall).
...
Install new `Stash` operator by following the instructions [here](/docs/0.7.0-rc.2/setup/install).
