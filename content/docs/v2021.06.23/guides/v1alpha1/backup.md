...
<p align="center">
  <img alt="Stash Backup Flow" src="/docs/v2021.06.23/images/v1alpha1/stash-backup.svg">
</p>
...
Here, we can see 4 last successful backup [Snapshot](/docs/v2021.06.23/concepts/crds/snapshot) taken by Stash in `deployment.stash-demo` repository.
