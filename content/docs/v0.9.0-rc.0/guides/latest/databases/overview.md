...
<figure align="center">
  <img alt="Database Backup Overview" src="/docs/v0.9.0-rc.0/images/guides/latest/databases/database_backup_overview.svg">
...
3. Then, she creates a `BackupConfiguration` crd targeting the [AppBinding](/docs/v0.9.0-rc.0/concepts/crds/appbinding) crd of the desired database. The `BackupConfiguration` object also specifies the `Task` to use to backup the database.
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v0.9.0-rc.0/images/guides/latest/databases/database_restore_overview.svg">
