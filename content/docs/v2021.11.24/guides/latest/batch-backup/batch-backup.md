...
- You should be familiar with the following `Stash` concepts:
  ...
  - [RestoreBatch](/docs/v2021.11.24/concepts/crds/restorebatch)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/batch-backup](/docs/v2021.11.24/examples/guides/latest/batch-backup) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="WordPress Setup Wizard" src="/docs/v2021.11.24/images/guides/latest/batch-backup/wordpress-setup.png">
...
<figure align="center">
  <img alt="Sample Post" src="/docs/v2021.11.24/images/guides/latest/batch-backup/sample-post.png">
...
We are going to store our backed up data into a GCS bucket. We have to create a Secret with the necessary credentials and a Repository CR to use this backend. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2021.11.24/guides/latest/backends/overview).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.11.24/images/guides/latest/batch-backup/backup-data.png">
...
<figure align="center">
  <img alt="Missing Sample Post" src="/docs/v2021.11.24/images/guides/latest/batch-backup/wp_missing.png">
...
<figure align="center">
  <img alt="Restored Sample Post" src="/docs/v2021.11.24/images/guides/latest/batch-backup/wp_restored.png">
