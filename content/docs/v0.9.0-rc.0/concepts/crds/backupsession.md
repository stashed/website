...
- Learn how backup of workloads data works from [here](/docs/v0.9.0-rc.0/guides/latest/workloads/overview).
- Learn how backup of databases works from [here](/docs/v0.9.0-rc.0/guides/latest/databases/overview).
- Learn how backup stand alone PVC works from [here](/docs/v0.9.0-rc.0/guides/latest/volumes/overview).
