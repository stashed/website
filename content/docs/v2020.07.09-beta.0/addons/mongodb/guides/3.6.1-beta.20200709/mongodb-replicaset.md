...
menu:
  docs_v2020.07.09-beta.0:
    identifier: mongodb-replicaset-3.6.1-beta.20200709
...
KubeDB creates an [AppBinding](/docs/v2020.07.09-beta.0/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
