...
menu:
  docs_v2020.10.30:
    identifier: standalone-mongodb-3.4.17-v3
    name: Standalone MongoDB
    parent: stash-mongodb-guides-3.4.17-v3
    weight: 10
product_name: stash
...
- Install MongoDB addon for Stash following the steps [here](/docs/v2020.10.30/addons/mongodb/setup/install).
...
- If you are not familiar with how Stash backup and restore MongoDB databases, please check the following guide [here](/docs/v2020.10.30/addons/mongodb/overview).
...
Here, we have to use service `sample-mongodb` and secret `sample-mongodb-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2020.10.30/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
