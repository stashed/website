...
`spec.task` specifies the name and parameters of the [Task](/docs/v0.9.0-rc.0/concepts/crds/task) crd to use to restore the target data.
...
- Learn how restore of workloads data works from [here](/docs/v0.9.0-rc.0/guides/latest/workloads/overview).
- Learn how restore of databases works from [here](/docs/v0.9.0-rc.0/guides/latest/databases/overview).
- Learn how restore stand-alone PVC works from [here](/docs/v0.9.0-rc.0/guides/latest/volumes/overview).
