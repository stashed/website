...
- Install Stash Enterprise in your cluster following the steps [here](/docs/v2022.05.18/setup/install/enterprise).
...
- If you are not familiar with how Stash backup and restore Elasticsearch databases, please check the following guide [here](/docs/v2022.05.18/addons/elasticsearch/overview/).
- If you are not familiar with how auto-backup works in Stash, please check the following guide [here](/docs/v2022.05.18/guides/auto-backup/overview).
- If you are not familiar with the available auto-backup options for databases in Stash, please check the following guide [here](/docs/v2022.05.18/guides/auto-backup/database).

You should be familiar with the following `Stash` concepts:

- [BackupBlueprint](/docs/v2022.05.18/concepts/crds/backupblueprint)
...
Now, we are ready to backup our Elasticsearch databases using few annotations. You can check available auto-backup annotations for a databases from [here](/docs/v2022.05.18/guides/auto-backup/database#available-auto-backup-annotations-for-database).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2022.05.18/addons/elasticsearch/auto-backup/images/es-demo.png">
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2022.05.18/addons/elasticsearch/auto-backup/images/es-demo-2.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2022.05.18/addons/elasticsearch/auto-backup/images/es-demo-3.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
