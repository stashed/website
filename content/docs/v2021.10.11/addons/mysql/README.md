...
url: /docs/v2021.10.11/addons/mysql/
aliases:
- /docs/v2021.10.11/addons/mysql/README/
info:
  cli: v0.16.0
  community: v0.16.0
  elasticsearch:
...
- [How does it works?](/docs/v2021.10.11/addons/mysql/overview/) gives an overview of how backup and restore process for MySQL database works in Stash.
- [Standalone MySQL Database](/docs/v2021.10.11/addons/mysql/standalone/) shows how to backup and restore a standalone MySQL database.
