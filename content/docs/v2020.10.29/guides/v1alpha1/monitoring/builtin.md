...
<p align="center">
  <img alt="Prometheus Target" src="/docs/v2020.10.29/images/v1alpha1/monitoring/prom-builtin-target.png" style="padding:10px">
</p>
...
- Learn how to monitor Stash using Prometheus operator from [here](/docs/v2020.10.29/guides/v1alpha1/monitoring/coreos).
