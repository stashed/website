...
Here, we have to use service `sample-mysql` and secret `sample-mysql-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v0.9.0-rc.6/concepts/crds/appbinding) CRD that holds the necessary information to connect with the database.
