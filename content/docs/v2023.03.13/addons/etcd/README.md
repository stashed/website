...
url: /docs/v2023.03.13/addons/etcd/
aliases:
- /docs/v2023.03.13/addons/etcd/README/
info:
  cli: v0.27.0
  community: v0.27.0
  elasticsearch:
...
- [How does it work?](/docs/v2023.03.13/addons/etcd/overview/) gives an overview of how backup and restore process for Etcd database works in Stash.
- [Etcd Cluster with Basic Auth](/docs/v2023.03.13/addons/etcd/basic-auth/) shows how to backup and restore an Etcd cluster with basic authentication enabled.
- [Etcd Cluster with TLS](/docs/v2023.03.13/addons/etcd/tls/) shows how to configure backup and restore process for TLS secured Etcd cluster.
- [Customizing Backup & Restore Process](/docs/v2023.03.13/addons/etcd/customization/) shows how to customize the backup & restore process.
