...
menu:
  docs_v2020.07.09-beta.0:
    identifier: mysql-guide-8.0.14-beta.20200709
    name: Backup & Restore MySQL
    parent: stash-mysql-guides-8.0.14-beta.20200709
    weight: 10
product_name: stash
...
Here, we have to use service `sample-mysql` and secret `sample-mysql-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2020.07.09-beta.0/concepts/crds/appbinding) CRD that holds the necessary information to connect with the database.
