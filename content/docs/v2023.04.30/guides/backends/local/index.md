...
- Learn how to use Stash to backup workloads data from [here](/docs/v2023.04.30/guides/workloads/overview/).
- Learn how to use Stash to backup databases from [here](/docs/v2023.04.30/guides/addons/overview/).
- Learn how to use Stash to backup stand-alone PVC from [here](/docs/v2023.04.30/guides/volumes/overview/).
