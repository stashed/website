...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/use-cases/pause-backup](/docs/v2022.05.12/examples/guides/use-cases/pause-backup) directory of [stashed/doc](https://github.com/stashed/doc) repository.
