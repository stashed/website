...
<figure align="center">
 <img alt="MongoDB Backup Overview" src="/docs/v2023.04.30/addons/mongodb/overview/images/backup_overview.svg">
...
3. Then, she creates a `BackupConfiguration` crd targeting the [AppBinding](/docs/v2023.04.30/concepts/crds/appbinding/) crd of the desired database. The `BackupConfiguration` object also specifies the `Task` to use to backup the database.
...
<figure align="center">
 <img alt="Standalone MongoDB Backup Overview" src="/docs/v2023.04.30/addons/mongodb/overview/images/standalone_backup.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Backup Overview" src="/docs/v2023.04.30/addons/mongodb/overview/images/replicaset_backup.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Backup Overview" src="/docs/v2023.04.30/addons/mongodb/overview/images/sharded_backup.svg">
...
<figure align="center">
 <img alt="Database Restore Overview" src="/docs/v2023.04.30/addons/mongodb/overview/images/restore_overview.svg">
...
<figure align="center">
 <img alt="Standalone MongoDB Restore Overview" src="/docs/v2023.04.30/addons/mongodb/overview/images/standalone_restore.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Restore Overview" src="/docs/v2023.04.30/addons/mongodb/overview/images/replicaset_restore.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Restore" src="/docs/v2023.04.30/addons/mongodb/overview/images/sharded_restore.svg">
  <figcaption align="center">Fig: MongoDB Sharded Cluster Restore</figcaption>
</figure>

## Next Steps

- Backup your standalone MongoDB database using Stash following the guide from [here](/docs/v2023.04.30/addons/mongodb/standalone/).
- Backup your MongoDB Replicaset using Stash following the guide from [here](/docs/v2023.04.30/addons/mongodb/replicaset/).
- Backup your sharded MongoDB cluster using Stash following the guide from [here](/docs/v2023.04.30/addons/mongodb/sharding/).
