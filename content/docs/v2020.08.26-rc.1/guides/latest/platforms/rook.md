...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/platforms/rook](/docs/v2020.08.26-rc.1/examples/guides/latest/platforms/rook) directory of [stashed/doc](https://github.com/stashed/doc) repository.
