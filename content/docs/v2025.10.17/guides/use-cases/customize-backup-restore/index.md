...
To know more about the available options for retention policies, please visit [here](/docs/v2025.10.17/concepts/crds/backupconfiguration/#specretentionpolicy).
