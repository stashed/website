...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/workloads/deployment/examples](/docs/v2023.10.9/guides/workloads/deployment/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
