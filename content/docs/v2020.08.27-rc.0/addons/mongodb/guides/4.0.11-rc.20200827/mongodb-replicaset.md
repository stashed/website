...
menu:
  docs_v2020.08.27-rc.0:
    identifier: mongodb-replicaset-4.0.11-rc.20200827
...
KubeDB creates an [AppBinding](/docs/v2020.08.27-rc.0/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
