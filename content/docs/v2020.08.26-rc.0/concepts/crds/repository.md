...
A `Repository` is a Kubernetes `CustomResourceDefinition`(CRD) which represents [backend](/docs/v2020.08.26-rc.0/guides/latest/backends/overview) information in a Kubernetes native way.
...
- **spec.backend**
`spec.backend` specifies the storage location where the backed up snapshots will be stored. To learn how to configure `Repository` crd for  various backends, please visit [here](/docs/v2020.08.26-rc.0/guides/latest/backends/overview).
...
- Learn how to create `Repository` crd for different backends from [here](/docs/v2020.08.26-rc.0/guides/latest/backends/overview).
- Learn how Stash backup workloads data from [here](/docs/v2020.08.26-rc.0/guides/latest/workloads/overview).
- Learn how Stash backup databases from [here](/docs/v2020.08.26-rc.0/guides/latest/addons/overview).
