...
- Learn how backup of workloads data works from [here](/docs/v2024.2.9-rc.0/guides/workloads/overview/).
- Learn how backup of databases works from [here](/docs/v2024.2.9-rc.0/guides/addons/overview/).
- Learn how backup stand alone PVC works from [here](/docs/v2024.2.9-rc.0/guides/volumes/overview/).
