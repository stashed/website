...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v2025.10.17/addons/postgres/overview/images/restore_overview.svg">
...
- Backup standalone PostgreSQL database using Stash following the guides from  [here](/docs/v2025.10.17/addons/postgres/standalone/).
