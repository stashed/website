...
> **Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/latest/platforms/eks](/docs/v2021.6.18/examples/guides/latest/platforms/eks) directory of [stashed/doc](https://github.com/stashed/doc) repository.
...
<figure align="center">
  <img alt="Backup data in AWS s3 Bucket" src="/docs/v2021.6.18/images/guides/latest/platforms/eks.png">
