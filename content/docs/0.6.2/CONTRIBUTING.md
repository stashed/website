...
url: /docs/0.6.2/welcome/contributing/
aliases:
- /docs/0.6.2/CONTRIBUTING/
info:
  version: 0.6.2
---
...
We have a [Developer Guide](/docs/0.6.2/setup/developer-guide/overview) that outlines everything you need to know from setting up your
