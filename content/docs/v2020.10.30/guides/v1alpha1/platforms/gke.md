...
This tutorial will show you how to use Stash to **backup** and **restore** a Kubernetes deployment in [Google Kubernetes Engine](https://cloud.google.com/kubernetes-engine/). Here, we are going to back up the `/source/data` folder of a busybox pod into [GCS bucket](/docs/v2020.10.30/guides/v1alpha1/backends/overview#google-cloud-storage-gcs). Then, we are going to show how to recover this data into a `gcePersistentDisk` and `PersistentVolumeClaim`. We are going to also re-deploy deployment using this recovered volume.
...
- You should be familiar with the following Stash concepts:
  - [Restic](/docs/v2020.10.30/concepts/crds/v1alpha1/restic)
  - [Repository](/docs/v2020.10.30/concepts/crds/repository)
  - [Recovery](/docs/v2020.10.30/concepts/crds/v1alpha1/recovery)
  - [Snapshot](/docs/v2020.10.30/concepts/crds/snapshot)
...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/gke](/docs/v2020.10.30/examples/platforms/gke) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
Now, we are ready backup `/source/data` directory into a [GCS bucket](/docs/v2020.10.30/guides/v1alpha1/backends/overview#google-cloud-storage-gcs),
...
Here, `deployment.stash-demo-c1014ca6` represents the name of the successful backup [Snapshot](/docs/v2020.10.30/concepts/crds/snapshot) taken by Stash in `deployment.stash-demo` repository.
...
<p align="center">
  <img alt="Repository in GCS Bucket", src="/docs/v2020.10.30/images/v1alpha1/platforms/gke/gcs-backup-repository.png">
</p>

To view the snapshot files, navigate to `snapshots` directory of the repository,

<p align="center">
  <img alt="Snapshot in GCS Bucket" src="/docs/v2020.10.30/images/v1alpha1/platforms/gke/gcs-backup-snapshots.png">
</p>
...
>In case of cluster disaster, you might lose `Repository` crd and backend secret. In this scenario, you have to create the secret again and `Repository` crd manually. Follow the guide to understand `Repository` crd structure from [here](/docs/v2020.10.30/concepts/crds/repository).
...
- To uninstall Stash from your cluster, follow the instructions from [here](/docs/v2020.10.30/setup/README).
