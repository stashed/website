...
menu:
  docs_v2020.10.30:
    identifier: mongodb-replicaset-3.6.13-v3
...
KubeDB creates an [AppBinding](/docs/v2020.10.30/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
