...
menu:
  docs_v2021.01.21:
    identifier: mongodb-replicaset-3.4.17-v5
...
KubeDB creates an [AppBinding](/docs/v2021.01.21/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
