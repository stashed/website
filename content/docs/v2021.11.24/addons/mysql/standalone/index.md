...
Here, we have to use service `sample-mysql` and secret `sample-mysql-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2021.11.24/concepts/crds/appbinding) CRD that holds the necessary information to connect with the database.
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.11.24/addons/mysql/standalone/images/sample-mysql-backup.png">
