...
menu:
  docs_v2020.08.27:
    identifier: mongodb-replicaset-4.0.11-v1
...
KubeDB creates an [AppBinding](/docs/v2020.08.27/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
