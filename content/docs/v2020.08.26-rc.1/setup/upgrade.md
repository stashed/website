...
If you are upgrading Stash to a patch release, please reapply the [installation instructions](/docs/v2020.08.26-rc.1/setup/README). That will upgrade the operator pod to the new version and fix any RBAC issues.
