...
>**Note:** YAML files used in this tutorial are stored in  [docs/examples/guides/latest/advanced-use-case/instant-backup](/docs/v2021.04.09/examples/guides/latest/advanced-use-case/instant-backup) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.04.09/images/guides/latest/advanced-use-case/instant.png">
