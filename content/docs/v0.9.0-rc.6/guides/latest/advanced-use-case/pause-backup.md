...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/advanced-use-case/pause-backup](/docs/v0.9.0-rc.6/examples/guides/latest/advanced-use-case/pause-backup) directory of [stashed/doc](https://github.com/stashed/doc) repository.
