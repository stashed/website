...
<figure align="center">
  <img alt="Create IAM policy (Step: 1)" src="/docs/v2024.2.9-rc.0/guides/platforms/eks-irsa/images/create-bucket-policy-1.png">
  <figcaption align="center">Fig: Create IAM policy (Step: 1)</figcaption>
</figure>

<figure align="center">
  <img alt="Create IAM policy (Step: 2)" src="/docs/v2024.2.9-rc.0/guides/platforms/eks-irsa/images/create-bucket-policy-2.png">
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2024.2.9-rc.0/guides/platforms/eks-irsa/images/gcs.png">
