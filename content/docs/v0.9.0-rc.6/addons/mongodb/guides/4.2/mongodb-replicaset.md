...
menu:
  docs_v0.9.0-rc.6:
    identifier: mongodb-replicaset-4.2
...
sample-mgo-rs-backup  mongodb-backup-4.2      */5 * * * *   true     26m
```
...
NAME              VERSION        STATUS         AGE
restored-mgo-rs   4.2         Initializing   2m
```
...
$ kubectl get mg -n demo restored-mgo-rs
NAME              VERSION        STATUS    AGE
restored-mgo-rs   4.2         Running   3m
```
...
$ kubectl get mg -n demo restored-mongodb
NAME               VERSION        STATUS    AGE
restored-mongodb   4.2         Running   2m
```
