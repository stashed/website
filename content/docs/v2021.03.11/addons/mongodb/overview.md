...
<figure align="center">
 <img alt="MongoDB Backup Overview" src="/docs/v2021.03.11/images/addons/mongodb/backup_overview.svg">
...
3. Then, she creates a `BackupConfiguration` crd targeting the [AppBinding](/docs/v2021.03.11/concepts/crds/appbinding) crd of the desired database. The `BackupConfiguration` object also specifies the `Task` to use to backup the database.
...
<figure align="center">
 <img alt="Standalone MongoDB Backup Overview" src="/docs/v2021.03.11/images/addons/mongodb/standalone_backup.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Backup Overview" src="/docs/v2021.03.11/images/addons/mongodb/replicaset_backup.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Backup Overview" src="/docs/v2021.03.11/images/addons/mongodb/sharded_backup.svg">
...
<figure align="center">
 <img alt="Database Restore Overview" src="/docs/v2021.03.11/images/addons/mongodb/restore_overview.svg">
...
<figure align="center">
 <img alt="Standalone MongoDB Restore Overview" src="/docs/v2021.03.11/images/addons/mongodb/standalone_restore.svg">
...
<figure align="center">
 <img alt="MongoDB ReplicaSet Cluster Restore Overview" src="/docs/v2021.03.11/images/addons/mongodb/replicaset_restore.svg">
...
<figure align="center">
 <img alt="MongoDB Sharded Cluster Restore" src="/docs/v2021.03.11/images/addons/mongodb/sharded_restore.svg">
  <figcaption align="center">Fig: MongoDB Sharded Cluster Restore</figcaption>
</figure>

## Next Steps

- Install MongoDB addon for Stash following the guide from [here](/docs/v2021.03.11/addons/mongodb/setup/install).
