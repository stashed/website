...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/rook](/docs/v2020.09.29/examples/platforms/rook) directory of [stashed/docs](https://github.com/stashed/docs) repository.
