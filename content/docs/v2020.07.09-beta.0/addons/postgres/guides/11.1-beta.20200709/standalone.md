...
menu:
  docs_v2020.07.09-beta.0:
    identifier: standalone-postgres-11.1-beta.20200709
    name: Standalone PostgreSQL
    parent: stash-postgres-guides-11.1-beta.20200709
    weight: 10
product_name: stash
...
Here, we have to use service `sample-postgres` and secret `sample-postgres-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2020.07.09-beta.0/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
