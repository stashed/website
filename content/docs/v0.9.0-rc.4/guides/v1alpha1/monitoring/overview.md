...
<p align="center">
  <img alt="Monitoring Structure"  src="/docs/v0.9.0-rc.4/images/v1alpha1/monitoring/stash-monitoring-structure.png">
</p>
...
- Learn how to monitor Stash using built-in Prometheus from [here](/docs/v0.9.0-rc.4/guides/v1alpha1/monitoring/builtin).
- Learn how to monitor Stash using Prometheus operator from [here](/docs/v0.9.0-rc.4/guides/v1alpha1/monitoring/coreos).
