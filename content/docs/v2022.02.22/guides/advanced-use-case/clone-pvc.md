...
> **Note:** YAML files used in this tutorial are stored in [/docs/examples/guides/advanced-use-case/clone-pvc](/docs/v2022.02.22/examples/guides/advanced-use-case/clone-pvc) directory of [stashed/docs](https://github.com/stashed/docs) repository.
