...
To know more about the available options for retention policies, please visit [here](/docs/v2022.03.29/concepts/crds/backupconfiguration#specretentionpolicy).
