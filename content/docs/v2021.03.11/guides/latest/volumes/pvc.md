...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/volumes](/docs/v2021.03.11/examples/guides/latest/volumes) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<figure align="center">
  <img alt="Backed up data of a stand-alone PVC in GCS backend" src="/docs/v2021.03.11/images/guides/latest/volumes/pvc_repo.png">
