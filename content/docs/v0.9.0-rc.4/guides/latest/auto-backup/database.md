...
- Install PostgreSQL addon for Stash following the steps [here](/docs/v0.9.0-rc.4/addons/postgres/setup/install).
...
- If you are not familiar with how Stash backup and restore PostgreSQL databases, please check the following guide [here](/docs/v0.9.0-rc.4/addons/postgres/overview).

You should be familiar with the following `Stash` concepts:

- [BackupBlueprint](/docs/v0.9.0-rc.4/concepts/crds/backupblueprint)
...
- [Function](/docs/v0.9.0-rc.4/concepts/crds/function)
- [Task](/docs/v0.9.0-rc.4/concepts/crds/task)
...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/auto-backup/database](/docs/v0.9.0-rc.4/examples/guides/latest/auto-backup/database) directory of [stashed/docs](https://github.com/stashed/docs) repository.

## Prepare Backup Blueprint

We are going to use [GCS Backend](/docs/v0.9.0-rc.4/guides/latest/backends/gcs) to store the backed up data. You can use any supported backend you prefer. You just have to configure Storage Secret and `spec.backend` section of `BackupBlueprint` to match with your backend. To learn which backends are supported by Stash and how to configure them, please visit [here](/docs/v0.9.0-rc.4/guides/latest/backends/overview).

> For GCS backend, if the bucket does not exist, Stash needs `Storage Object Admin` role permissions to create the bucket. For more details, please check the following [guide](/docs/v0.9.0-rc.4/guides/latest/backends/gcs).
...
<figure align="center">
  <img alt="Backup data of PostgreSQL 'sample-postgres-1' in GCS backend" src="/docs/v0.9.0-rc.4/images/guides/latest/auto-backup/database/sample_postgres_1.png">
...
<figure align="center">
  <img alt="Backup data of PostgreSQL 'sample-postgres-2' in GCS backend" src="/docs/v0.9.0-rc.4/images/guides/latest/auto-backup/database/sample_postgres_2.png">
