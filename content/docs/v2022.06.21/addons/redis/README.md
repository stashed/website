...
url: /docs/v2022.06.21/addons/redis/
aliases:
- /docs/v2022.06.21/addons/redis/README/
info:
  cli: v0.21.0
  community: v0.21.0
  elasticsearch:
...
- [How does it work?](/docs/v2022.06.21/addons/redis/overview/) gives an overview of how backup and restore process for Redis database works in Stash.
- [Helm managed Redis](/docs/v2022.06.21/addons/redis/helm/) shows how to backup and restore a Helm managed Redis database.
- [Auto-Backup](/docs/v2022.06.21/addons/redis/auto-backup/) shows how to configure a generic backup template for all the Redis databases of a cluster.
- [Customizing Backup & Restore Process](/docs/v2022.06.21/addons/redis/customization/) shows how to customize the backup & restore process.
