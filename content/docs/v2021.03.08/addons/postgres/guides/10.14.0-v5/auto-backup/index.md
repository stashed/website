...
menu:
  docs_v2021.03.08:
    identifier: standalone-postgres-10.14.0-v5-auto-backup
    name: Auto-Backup
    parent: stash-postgres-guides-10.14.0-v5
    weight: 20
product_name: stash
...
- If you are not familiar with how Stash backup and restore PostgreSQL databases, please check the following guide [here](/docs/v2021.03.08/addons/postgres/overview).
- If you are not familiar with how auto-backup works in Stash, please check the following guide [here](/docs/v2021.03.08/guides/latest/auto-backup/overview).
- If you are not familiar with the available auto-backup options for databases in Stash, please check the following guide [here](/docs/v2021.03.08/guides/latest/auto-backup/database).

You should be familiar with the following `Stash` concepts:

- [BackupBlueprint](/docs/v2021.03.08/concepts/crds/backupblueprint)
...
Make sure you have installed the PostgreSQL addon for Stash. If you haven't installed it already, please install the addon following the steps [here](/docs/v2021.03.08/addons/postgres/setup/install).
...
Now, we are ready to backup our PostgreSQL databases using few annotations. You can check available auto-backup annotations for a database from [here](/docs/v2021.03.08/guides/latest/auto-backup/database/#available-auto-backup-annotations-for-database).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.08/addons/postgres/guides/{{< param "info.subproject_version" >}}/auto-backup/images/sample-postgres-1.png">
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.08/addons/postgres/guides/{{< param "info.subproject_version" >}}/auto-backup/images/sample-postgres-2.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.08/addons/postgres/guides/{{< param "info.subproject_version" >}}/auto-backup/images/sample-postgres-3.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
