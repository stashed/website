...
url: /docs/v2021.04.07/guides/v1alpha1/
aliases:
- /docs/v2021.04.07/guides/v1alpha1/README/
info:
  cli: v0.12.1
  community: v0.12.1
  elasticsearch:
...
- Learn to use Stash in Google Kubernetes Engine [here](/docs/v2021.04.07/guides/v1alpha1/platforms/gke)
- Learn to use Stash with self-hosted TLS secured Minio Server [here](/docs/v2021.04.07/guides/v1alpha1/platforms/minio).
- Learn to use Stash in Rook Storage System [here](/docs/v2021.04.07/guides/v1alpha1/platforms/rook)
