...
This addon should be able to take backup of the databases with matching major versions as discussed in [Addon Version Compatibility](/docs/v2025.2.10/addons/mariadb/README#addon-version-compatibility).
