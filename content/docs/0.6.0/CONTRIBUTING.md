...
url: /docs/0.6.0/welcome/contributing/
aliases:
- /docs/0.6.0/CONTRIBUTING/
info:
  version: 0.6.0
---
...
We have a [Developer Guide](/docs/0.6.0/setup/developer-guide/overview) that outlines everything you need to know from setting up your
