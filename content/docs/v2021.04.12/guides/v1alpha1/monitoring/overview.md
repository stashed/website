...
<p align="center">
  <img alt="Monitoring Structure"  src="/docs/v2021.04.12/images/v1alpha1/monitoring/stash-monitoring-structure.png">
</p>
...
- Learn how to monitor Stash using built-in Prometheus from [here](/docs/v2021.04.12/guides/v1alpha1/monitoring/builtin).
