...
> **Note:** YAML files used in this tutorial are stored in [docs/examples/guides/latest/workloads](/docs/v2021.06.23/examples/guides/latest/workloads) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
We are going to store our backed up data into a GCS bucket. We have to create a Secret with necessary credentials and a Repository crd to use this backend. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2021.06.23/guides/latest/backends/overview).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.06.23/images/guides/latest/workloads/gcs_bucket_dep.png">
