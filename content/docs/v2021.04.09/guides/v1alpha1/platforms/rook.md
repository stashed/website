...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/rook](/docs/v2021.04.09/examples/platforms/rook) directory of [stashed/docs](https://github.com/stashed/docs) repository.
