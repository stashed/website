...
- Learn how backup of workloads data works from [here](/docs/v2021.04.07/guides/latest/workloads/overview).
- Learn how backup of databases works from [here](/docs/v2021.04.07/guides/latest/addons/overview).
- Learn how backup stand alone PVC works from [here](/docs/v2021.04.07/guides/latest/volumes/overview).
