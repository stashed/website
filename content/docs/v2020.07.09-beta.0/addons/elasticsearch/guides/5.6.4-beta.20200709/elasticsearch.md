...
menu:
  docs_v2020.07.09-beta.0:
    identifier: standalone-elasticsearch-5.6.4-beta.20200709
    name: Backup & Restore Elasticsearch
    parent: stash-elasticsearch-guides-5.6.4-beta.20200709
    weight: 10
product_name: stash
...
- Install Elasticsearch addon for Stash following the steps [here](/docs/v2020.07.09-beta.0/addons/elasticsearch/setup/install).
...
- If you are not familiar with how Stash backup and restore Elasticsearch databases, please check the following guide [here](/docs/v2020.07.09-beta.0/addons/elasticsearch/overview).
...
Here, we have to use service `sample-elasticsearch` and secret `sample-elasticsearch-auth` to connect with the database. KubeDB creates an [AppBinding](/docs/v2020.07.09-beta.0/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
