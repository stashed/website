...
Enable Prometheus monitoring using `prometheus.io/builtin` agent while installing Stash. To know details about how to enable monitoring see [here](/docs/0.8.1/guides/monitoring/overview#how-to-enable-monitoring). Here, we are going to enable monitoring for both `backup & recovery` and `operator` metrics.
...
<p align="center">
  <img alt="Prometheus Target" src="/docs/0.8.1/images/monitoring/prom-builtin-target.png" style="padding:10px">
</p>
...
To uninstall Stash follow this [guide](/docs/0.8.1/setup/uninstall).
...
- Learn how to use Grafana dashboard to visualize monitoring data from [here](/docs/0.8.1/guides/monitoring/grafana).