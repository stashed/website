...
<p align="center">
  <img alt="Monitoring Structure"  src="/docs/0.8.1/images/monitoring/stash-monitoring-structure.png">
</p>
...
- Learn how to monitor Stash using built-in Prometheus from [here](/docs/0.8.1/guides/monitoring/builtin).
