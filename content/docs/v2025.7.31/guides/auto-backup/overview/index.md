...
7. Finally, Stash starts rest of the standard backup process as discussed in [here](/docs/v2025.7.31/guides/workloads/overview/).
...
- Learn how to configure automatic backup for databases from [here](/docs/v2025.7.31/guides/auto-backup/database/).
