...
- You should be familiar with the following `Stash` concepts:
  ...
  - [RestoreBatch](/docs/v2024.9.30/concepts/crds/restorebatch/)
...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/batch-backup/wordpress-backup/examples](/docs/v2024.9.30/guides/batch-backup/wordpress-backup/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
We are going to store our backed up data into a GCS bucket. We have to create a Secret with the necessary credentials and a Repository CR to use this backend. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2024.9.30/guides/backends/overview/).
