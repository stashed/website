...
menu:
  docs_v0.9.0-rc.6:
    identifier: kubectl-stash-delete-v0.3.1
    name: Delete
...
* [kubectl-stash delete snapshot](/docs/v0.9.0-rc.6/guides/latest/cli/reference/{{< param "info.subproject_version" >}}/kubectl-stash_delete_snapshot)	 - Delete a snapshot from repository backend
