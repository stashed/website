...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/minio](/docs/v2020.08.26-rc.0/examples/platforms/minio) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
Here, we can see 5 last successful backup [Snapshot](/docs/v2020.08.26-rc.0/concepts/crds/snapshot) taken by Stash in `deployment.stash-demo` repository.
...
<p align="center">
  <img alt="Repository in Minio Backend",  height="350px" src="/docs/v2020.08.26-rc.0/images/v1alpha1/platforms/minio/minio-repository.png">
</p>

To view the snapshot files, navigate to `snapshots` directory of the repository,

<p align="center">
  <img alt="Snapshot in Minio Bucket" height="350px" src="/docs/v2020.08.26-rc.0/images/v1alpha1/platforms/minio/minio-snapshots.png">
</p>
...
- If you have deployed Minio server by following the tutorial we have linked in [Before You Begin](/docs/v2020.08.26-rc.0/guides/v1alpha1/platforms/minio#before-you-begin) section, please clean-up Minio resources by following the [cleanup](https://github.com/appscode/third-party-tools/blob/master/storage/minio/README#cleanup) section of that tutorial.
