...
url: /docs/v2021.01.21/addons/postgres/
aliases:
- /docs/v2021.01.21/addons/postgres/README/
info:
  catalog: v2021.01.21
  cli: v0.11.9
  community: v0.11.9
...
{{< versionlist "postgres" "/docs/v2021.01.21/addons/postgres/guides/%s/standalone" >}}
...
- [How does it works?](/docs/v2021.01.21/addons/postgres/overview) gives an overview of how backup and restore process for PostgreSQL database works in Stash.
- [Setup](/docs/v2021.01.21/addons/postgres/setup/install) shows how to install and uninstall PostgreSQL addon for Stash.
