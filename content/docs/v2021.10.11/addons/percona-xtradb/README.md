...
url: /docs/v2021.10.11/addons/percona-xtradb/
aliases:
- /docs/v2021.10.11/addons/percona-xtradb/README/
info:
  cli: v0.16.0
  community: v0.16.0
  elasticsearch:
...
- [How does it works?](/docs/v2021.10.11/addons/percona-xtradb/overview/) gives an overview of how backup and restore process for Percona XtraDB database works in Stash.
- [Standalone Percona-XtraDB](/docs/v2021.10.11/addons/percona-xtradb/standalone/) shows how to backup and restore a standalone Percona-XtraDB database.
- [Percona-XtraDB Cluster](/docs/v2021.10.11/addons/percona-xtradb/cluster/) shows how to backup & restore  a Percona-XtraDB cluster.
