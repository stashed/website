...
menu:
  docs_v2021.03.11:
    identifier: mariadb-guide-10.5.8-v1-helm
    name: Logical Backup
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.11/addons/mariadb/guides/{{< param "info.subproject_version" >}}/helm/images/sample-mariadb-backup.png">
