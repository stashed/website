...
## Deployments
To backup a Deployment, create a Restic with matching selectors. You can find a full working demo in [examples folder](/docs/0.7.0-rc.5/examples/workloads/deployment.yaml).

## ReplicaSets
To backup a ReplicaSet, create a Restic with matching selectors. You can find a full working demo in [examples folder](/docs/0.7.0-rc.5/examples/workloads/replicaset.yaml).

## ReplicationControllers
To backup a ReplicationController, create a Restic with matching selectors. You can find a full working demo in [examples folder](/docs/0.7.0-rc.5/examples/workloads/rc.yaml).
...
You can find the full working demo in [examples folder](/docs/0.7.0-rc.5/examples/workloads/statefulset.yaml). The section you should change for your own StatefulSet are:
...
To learn about the meaning of various flags, please visit [here](/docs/0.7.0-rc.5/reference/stash_backup).
...
- Wondering what features are coming next? Please visit [here](/docs/0.7.0-rc.5/roadmap).
