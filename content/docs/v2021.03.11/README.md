...
- [Concepts](/docs/v2021.03.11/concepts/). Concepts explain some significant aspect of Stash. This is where you can learn about what Stash does and how it does it.

- [Setup](/docs/v2021.03.11/setup/). Setup contains instructions for installing
  the Stash in various cloud providers.

- [Guides](/docs/v2021.03.11/guides/latest/). Guides show you how to perform tasks with Stash.

- [Reference](/docs/v2021.03.11/reference/). Detailed exhaustive lists of
