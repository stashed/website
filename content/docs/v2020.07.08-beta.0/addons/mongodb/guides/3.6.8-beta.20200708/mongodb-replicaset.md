...
menu:
  docs_v2020.07.08-beta.0:
    identifier: mongodb-replicaset-3.6.8-beta.20200708
...
KubeDB creates an [AppBinding](/docs/v2020.07.08-beta.0/concepts/crds/appbinding) crd that holds the necessary information to connect with the database.
