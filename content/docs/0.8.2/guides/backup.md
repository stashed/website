...
<p align="center">
  <img alt="Stash Backup Flow" src="/docs/0.8.2/images/stash-backup.svg">
</p>
...
Here, we can see 4 last successful backup [Snapshot](/docs/0.8.2/concepts/crds/snapshot) taken by Stash in `deployment.stash-demo` repository.
