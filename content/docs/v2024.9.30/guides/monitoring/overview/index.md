...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v2024.9.30/guides/monitoring/overview/images/monitoring-structure.svg">
...
The following instruction show example of enabling monitoring in Stash for the Prometheus server deployed with Prometheus Operator. You can check the [Builtin Prometheus](/docs/v2024.9.30/guides/monitoring/prom-builtin/) scraper guide if you are managing your Prometheus server manually.
