...
> **Note:** YAML files used in this tutorial are stored in [docs/guides/workloads/statefulset/examples](/docs/v2023.05.31/guides/workloads/statefulset/examples) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
We are going to store our backed up data into a GCS bucket. We have to create a Secret with necessary credentials and a Repository crd to use this backend. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2023.05.31/guides/backends/overview/).
