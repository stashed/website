...
url: /docs/v2024.8.27/addons/mariadb/
aliases:
- /docs/v2024.8.27/addons/mariadb/README/
info:
  cli: v0.35.0
  community: v0.35.0
  elasticsearch:
...
- [How does it work?](/docs/v2024.8.27/addons/mariadb/overview/) gives an overview of how backup and restore process for MariaDB database works in Stash.
- [Helm managed MariaDB](/docs/v2024.8.27/addons/mariadb/helm/) shows how to backup and restore a Helm managed MariaDB database.
- [Auto-Backup](/docs/v2024.8.27/addons/mariadb/auto-backup/) shows how to configure a generic backup template for all the MariaDB databases of a cluster.
- [Customizing Backup & Restore Process](/docs/v2024.8.27/addons/mariadb/customization/) shows how to customize the backup & restore process.
