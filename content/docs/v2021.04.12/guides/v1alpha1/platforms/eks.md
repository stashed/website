...
>Note: YAML files used in this tutorial are stored in [/docs/examples/platforms/eks](/docs/v2021.04.12/examples/platforms/eks) directory of [stashed/docs](https://github.com/stashed/docs) repository.
...
<p align="center">
  <img alt="Repository in AWS S3 Backend",  height="350px" src="/docs/v2021.04.12/images/v1alpha1/platforms/eks/s3-backup-repository.png">
</p>

To view the snapshot files, navigate to `snapshots` directory of the repository,

<p align="center">
  <img alt="Snapshot in AWS S3 Bucket" height="350px" src="/docs/v2021.04.12/images/v1alpha1/platforms/eks/s3-backup-snapshots.png">
</p>
