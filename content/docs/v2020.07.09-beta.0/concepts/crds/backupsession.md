...
- Learn how backup of workloads data works from [here](/docs/v2020.07.09-beta.0/guides/latest/workloads/overview).
- Learn how backup of databases works from [here](/docs/v2020.07.09-beta.0/guides/latest/addons/overview).
- Learn how backup stand alone PVC works from [here](/docs/v2020.07.09-beta.0/guides/latest/volumes/overview).
