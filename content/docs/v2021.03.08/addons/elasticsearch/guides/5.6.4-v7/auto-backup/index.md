...
menu:
  docs_v2021.03.08:
    identifier: stash-elasticsearch-guides-5.6.4-v7-auto-backup
    name: Auto-Backup
    parent: stash-elasticsearch-guides-5.6.4-v7
    weight: 60
product_name: stash
...
Make sure you have installed the Elasticsearch addon for Stash. If you haven't installed it already, please install the addon following the steps [here](/docs/v2021.03.08/addons/elasticsearch/setup/install).
...
Now, we are ready to backup our Elasticsearch databases using few annotations. You can check available auto-backup annotations for a databases from [here](/docs/v2021.03.08/guides/latest/auto-backup/database/#available-auto-backup-annotations-for-database).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.08/addons/elasticsearch/guides/{{< param "info.subproject_version" >}}/auto-backup/images/es-demo.png">
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.08/addons/elasticsearch/guides/{{< param "info.subproject_version" >}}/auto-backup/images/es-demo-2.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2021.03.08/addons/elasticsearch/guides/{{< param "info.subproject_version" >}}/auto-backup/images/es-demo-3.png">
  <figcaption align="center">Fig: Backup data in GCS Bucket</figcaption>
</figure>
