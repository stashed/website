...
Stash Community edition is available under [AppsCode-Community-1.0.0](https://github.com/appscode/licenses/raw/1.0.0/AppsCode-Community-1.0.0.md) license and free to use for both commercial and non-commercial purposes. It comes with all the basic backup functionalities. However, it lacks some advanced features such as [Database Backup](/docs/v2022.06.27/guides/addons/overview), [Auto-Backup](/docs/v2022.06.27/guides/auto-backup/overview), [Batch Backup](/docs/v2022.06.27/guides/batch-backup/overview), and [Local Backend](/docs/v2022.06.27/guides/backends/local) support, etc. compared to the Enterprise edition. A full features comparison between the Stash Community edition and Enterprise edition can be found [here](/docs/v2022.06.27/concepts/what-is-stash/overview).
...
- **RBAC permissions**: Stash operator needs a few RBAC permissions on your cluster. You can find the list of the required RBAC permissions [here](/docs/v2022.06.27/guides/security/rbac).
...
<figure align="center">
  <img alt="Stash Backend Overview" src="/docs/v2022.06.27/images/setup/community_license_form.png">
  <figcaption align="center">Fig: Stash License Form</figcaption>
</figure>

You can create licenses for as many clusters as you want. You can upgrade your license any time without re-installing Stash by following the upgrading guide from [here](/docs/v2022.06.27/setup/upgrade/#upgrading-license).
...
Now, you are ready to [take your first backup](/docs/v2022.06.27/guides/README) using Stash.
