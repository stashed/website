...
Enable Prometheus monitoring using `prometheus.io/coreos-operator` agent while installing Stash. To know details about how to enable monitoring see [here](/docs/v0.9.0-rc.1/guides/latest/monitoring/overview#how-to-enable-monitoring).
...
<figure align="center">
  <img alt="Stash Monitoring Flow" src="/docs/v0.9.0-rc.1/images/guides/latest/monitoring/prom-coreos-target.png">
...
- Learn how to monitor Stash using builtin Prometheus from [here](/docs/v0.9.0-rc.1/guides/latest/monitoring/builtin).
