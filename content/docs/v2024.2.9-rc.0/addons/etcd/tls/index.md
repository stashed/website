...
- If you are not familiar with how Stash backup and restore Etcd databases, please check the following guide [here](/docs/v2024.2.9-rc.0/addons/etcd/overview/).
...
<figure align="center">
  <img alt="Backup data in GCS Bucket" src="/docs/v2024.2.9-rc.0/addons/etcd/tls/images/etcd-tls-backup.jpg">
