...
<figure align="center">
  <img alt="MySQL Backup Overview" src="/docs/v0.9.0-rc.1/images/addons/mysql/backup_overview.svg">
...
<figure align="center">
  <img alt="Database Restore Overview" src="/docs/v0.9.0-rc.1/images/addons/mysql/restore_overview.svg">
...
- Install MySQL addon for Stash following the guide from [here](/docs/v0.9.0-rc.1/addons/mysql/setup/install).
