...
- Install MariaDB addon for Stash following the steps [here](/docs/v2021.01.21/addons/mariadb/setup/install).
- If you are not familiar with how Stash backup and restore MariaDB databases, please check the following guide [here](/docs/v2021.01.21/addons/mariadb/overview).

You have to be familiar with following custom resources:

- [AppBinding](/docs/v2021.01.21/concepts/objects/appbinding)
- [Function](/docs/v2021.01.21/concepts/objects/function)
- [Task](/docs/v2021.01.21/concepts/objects/task)
- [BackupConfiguration](/docs/v2021.01.21/concepts/objects/backupconfiguration)
- [BackupSession](/docs/v2021.01.21/concepts/objects/backupsession)
- [RestoreSession](/docs/v2021.01.21/concepts/objects/restoresession)
...
At first, make sure that you have installed Stash MariaDB addon version {{< param "info.subproject_version" >}}. If haven't install the addon yet, install it by following the setup guide from [here](/docs/v2021.01.21/addons/mariadb/setup/install).
...
This addon should be able to take backup of the databases with matching major versions as discussed in [Addon Version Compatibility](/docs/v2021.01.21/addons/mariadb/README#addon-version-compatibility).
...
We are going to store our backed up data into a GCS bucket. So, we need to create a Secret with GCS credentials and a `Repository` object with the bucket information. If you want to use a different backend, please read the respective backend configuration doc from [here](/docs/v2021.01.21/guides/latest/backends/overview).
