...
url: /docs/v2025.7.31/addons/etcd/
aliases:
- /docs/v2025.7.31/addons/etcd/README/
info:
  cli: v0.41.0
  community: v0.41.0
  elasticsearch:
...
- [How does it work?](/docs/v2025.7.31/addons/etcd/overview/) gives an overview of how backup and restore process for Etcd database works in Stash.
- [Etcd Cluster with Basic Auth](/docs/v2025.7.31/addons/etcd/basic-auth/) shows how to backup and restore an Etcd cluster with basic authentication enabled.
- [Etcd Cluster with TLS](/docs/v2025.7.31/addons/etcd/tls/) shows how to configure backup and restore process for TLS secured Etcd cluster.
- [Customizing Backup & Restore Process](/docs/v2025.7.31/addons/etcd/customization/) shows how to customize the backup & restore process.
